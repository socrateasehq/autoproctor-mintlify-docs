...
For more details, see [Showing Results to Candidates](/socratease/show-results-to-candidates).
...
- [Showing Results to Candidates](/socratease/show-results-to-candidates) -- Control result visibility
- [Using LaTeX for Math Equations](/socratease/latex-math-equations) -- Add mathematical equations to your quizzes
- [Timer Settings](/create/timer-settings) -- For general test timer and proctoring configuration (separate from Socratease quiz settings)
- [Creating a Quiz](/socratease/create-socratease-quiz) -- Step-by-step guide to creating a quiz
