...
<Note>
Question Banks are an **Elite** plan feature. You need an Elite subscription to create and use Question Banks and Question Bank Quizzes. See [Elite Features](/pricing/elite-plan-features) for details.
</Note>
...
- [Bulk Import from Excel](/socratease/import-questions-from-excel) -- Import questions in bulk to populate your Question Banks
- [Question Types](/socratease/socratease-question-types) -- Available question formats for use in Question Banks
