...
<Note>
Question Display Mode is a **Premium** feature. See [Payments and Credits](/pricing-account/plans-credits/payments-and-credits) for plan details.
</Note>
...
<Frame caption="All-at-once display mode">
  <img src="/images/socratease/all-at-once.png" alt="Candidate view of all-at-once display mode showing all questions on one page" />
</Frame>
...
<Frame caption="One-by-one with navigation">
  <img src="/images/socratease/one-by-one-like-typeform.png" alt="Candidate view of one-by-one with navigation display mode showing a single question with Next and Previous buttons" />
</Frame>
...
<Frame caption="One-by-one without navigation">
  <img src="/images/socratease/one-by-one.png" alt="Candidate view of one-by-one without navigation display mode showing a single question with Submit and Skip buttons" />
</Frame>
...
For more information on timer configuration, see [Timer Settings](/tests-results/create/timer-settings).
...
- [Timer Settings](/tests-results/create/timer-settings) -- Configure test-level and question-level timers
