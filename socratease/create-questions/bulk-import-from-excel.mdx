...
<Note>
Bulk Import is available to **Elite Plan** customers only. See [Elite Features](/pricing-account/plans-credits/elite-features) for details.
</Note>
...
<Note>
Bulk Import currently supports **MCQ** and **MCA** question types only. For other question types, add them manually through the quiz editor. See [Question Types](/socratease/create-questions/question-types) for the full list of available formats.
</Note>

## Related Resources

- [Question Types](/socratease/create-questions/question-types) -- All available question formats
- [Question Banks](/socratease/create-questions/question-banks) -- Create randomized question pools from your imported questions
- [Quiz Settings](/socratease/settings/quiz-settings) -- Configure your quiz behavior
- [Question Display Mode](/socratease/settings/question-display-mode) -- Control how questions appear to candidates
