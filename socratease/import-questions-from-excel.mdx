...
<Note>
Bulk Import is available to **Elite Plan** customers only. See [Elite Features](/pricing/elite-plan-features) for details.
</Note>
...
<Note>
Bulk Import currently supports **MCQ** and **MCA** question types only. For other question types, add them manually through the quiz editor. See [Question Types](/socratease/socratease-question-types) for the full list of available formats.
</Note>
