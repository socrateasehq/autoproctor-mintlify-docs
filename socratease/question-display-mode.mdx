...
<Note>
Question Display Mode is a **Premium** feature. See [Payments and Credits](/pricing/payments-and-credits) for plan details.
</Note>
...
For more information on timer configuration, see [Timer Settings](/create/timer-settings).
...
- [Timer Settings](/create/timer-settings) -- Configure test-level and question-level timers
