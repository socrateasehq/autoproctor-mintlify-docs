...
<Steps>
  <Step title="Take the demo test">
    Visit the [AutoProctor demo test](https://www.autoproctor.co/demo) to verify that your device and browser are compatible. If the demo also fails to load, your device does not support AutoProctor.
  </Step>
