...
- [Instructions for Taking a Proctored Test](/taking-tests/proctored-test-instructions) -- Google Account Setup section
- [Instructions for Taking a Timed Test](/taking-tests/timed-test-instructions) -- Google Account Setup section
</Note>
