...
- [Instructions for Taking a Proctored Test](/candidate/take-proctored-exam) -- Google Account Setup section
- [Instructions for Taking a Timed Test](/candidate/take-timed-exam) -- Google Account Setup section
</Note>

## Related Resources

- [Cannot Click on Answer](/candidate-issues/cannot-click-answers-during-test) -- Similar issue caused by wrong Google account
- [Cannot See Questions on Google Forms](/candidate-issues/google-forms-questions-not-visible) -- Google Form access issues
- [Test Stuck at Loading Screen](/candidate-issues/test-stuck-at-loading-screen) -- Other loading issues
- [How to Logout](/candidate/how-to-logout) -- Steps to switch accounts
- [Device Compatibility](/understanding/device-compatibility) -- Check supported browsers and devices
