...
<Steps>
  ...
  <Step title="Verify your account has sufficient credits">
    ...
    See [Payments and Credits](/payments-and-credits) to check your balance and purchase more if needed.
  ...
  <Step title="Configure test timing with buffer">
    ...
    See [Timer Settings](/timer-settings) for configuration details.
  </Step>
...
<Steps>
  <Step title="Review proctoring results">
    Check [Trust Scores](/what-is-trust-score) and proctoring reports for each candidate. Focus your review on candidates scoring below 85%.
  ...
  <Step title="Help candidates with technical issues">
    If candidates face any technical issue during the test, ask them to follow [this article](/contact-us).
  </Step>
</Steps>
...
- [Trust Score](/what-is-trust-score) -- How Trust Scores are calculated
- [Proctoring Settings](/proctoring-settings) -- Configure what gets monitored during tests
- [Concurrency](/max-simultaneous-candidates) -- Understand simultaneous candidate limits
