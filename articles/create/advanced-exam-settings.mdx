...
For more details on how each login method works, see [Candidate Login Methods](/candidate-login-methods).
...
For detailed instructions, see [Restricting by Email](/restrict-access-by-email). If you want to invite a specific set of candidates, see [Inviting Candidates via Email](/invite-candidates-via-email).
...
For more details, see [Adding Collaborators](/add-collaborators).
...
For setup instructions, see [Google Sheets Integration](/write-results-to-google-sheets).
...
<Note>
Unique URL per candidate is an Elite feature. See [Elite Features](/elite-plan-features) for more details.
</Note>
...
<Note>
Additional Instructions is an Elite feature. See the [Instructions Page for Candidates](/candidate-instructions-page) for more on what candidates see before starting.
</Note>
...
- [Restricting by Email](/restrict-access-by-email) — Restrict test access by email address or domain
- [Inviting Candidates via Email](/invite-candidates-via-email) — Send test invitations directly
- [Candidate Login Methods](/candidate-login-methods) — How each login method works
- [Google Sheets Integration](/write-results-to-google-sheets) — Auto-export results to spreadsheets
