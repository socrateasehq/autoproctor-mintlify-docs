...
The test administrator may have disabled evidence storage through the test's proctoring configuration. Check your [proctoring settings](/proctoring-settings) to confirm that evidence recording is enabled.
...
- [Missing Random Photos](/missing-random-photos) -- Why random photos may be absent
- [Missing Images and Recordings](/missing-images-and-recordings) -- Evidence missing from reports
- [Proctoring Settings](/proctoring-settings) -- Configure evidence storage and proctoring options
