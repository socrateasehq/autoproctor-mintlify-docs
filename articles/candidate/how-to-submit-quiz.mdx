...
<Note>
Socratease Quizzes are available on **all plans**, including the free trial. See [Why Socratease?](/why-socratease) for more benefits.
</Note>
...
- [Proctored Test Instructions](/take-proctored-exam) -- Full guide for proctored tests
- [Timed Test Instructions](/take-timed-exam) -- Full guide for timed tests
- [Proctored Socratease Instructions](/take-proctored-socratease-quiz) -- Simpler guide for Socratease
- [Google Forms Response Not Visible](/google-forms-response-not-visible) -- Troubleshoot missing submissions
- [Why Socratease?](/why-socratease) -- Benefits of using Socratease over Google Forms
