...
AutoProctor monitors candidates in real time across multiple channels (depending on your [proctoring settings](/proctoring-settings)):
...
- [Access Answers and Candidate Responses](/access-candidate-responses) -- Reviewing a single candidate's report in detail
- [No Face or Multiple Faces Detected](/no-face-or-multiple-faces-detected) -- Why face detection may flag false positives
- [False App Switch Violation](/false-app-switch-alert) -- Understanding false violation flags
- [Best Practices for Test Creators](/best-practices-for-exam-creators) -- Tips for running effective proctored tests
