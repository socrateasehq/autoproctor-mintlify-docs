...
<Steps>
  <Step title="Open the demo test link">
    ...
    [Take the Demo Test](https://www.autoproctor.co/tests/bj0yv14Ufu/load/)
...
- [Slow and Laggy Test](/test-slow-and-laggy) -- Fix performance problems
- [Blank Page or Grey Screen](/blank-screen-during-test) -- Resolve display issues
- [Proctored Test Instructions](/take-proctored-exam) -- What candidates need to know before starting
- [Best Practices for Test Creators](/best-practices-for-exam-creators) -- Tips including sharing the demo test in advance
