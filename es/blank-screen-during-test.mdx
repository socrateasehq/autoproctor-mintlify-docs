...
- [Instrucciones para Realizar un Examen Supervisado](/take-proctored-exam) -- Sección de Configuración de la Cuenta de Google
- [Instrucciones para Realizar un Examen Cronometrado](/take-timed-exam) -- Sección de Configuración de la Cuenta de Google
</Note>

## Recursos Relacionados

- [No Se Puede Hacer Clic en la Respuesta](/cannot-click-answers-during-test) -- Problema similar causado por la cuenta de Google incorrecta
- [No Se Pueden Ver las Preguntas en Google Forms](/google-forms-questions-not-visible) -- Problemas de acceso a Google Forms
- [El Examen Se Queda en la Pantalla de Carga](/test-stuck-at-loading-screen) -- Otros problemas de carga
