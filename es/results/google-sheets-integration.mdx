...
<Note>
Si necesita datos detallados a nivel de pregunta para Socratease Quizzes, utilice la vista de [entregas individuales](/results/individual-submissions) en el [panel de AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>
