...
<Note>
Si necesita datos detallados a nivel de pregunta para Socratease Quizzes, utilice la vista de [entregas individuales](/results/access-candidate-responses) en el [panel de AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>

## Recursos Relacionados

- [Exportar a Excel](/results/export-results-to-excel) -- Descargar resultados manualmente como hoja de cálculo
- [Acceder a Respuestas y Entregas del Candidato](/results/access-candidate-responses) -- Ver respuestas detalladas por candidato
