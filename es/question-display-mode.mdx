...
<Note>
Modo de Visualización de Preguntas es una función **Premium**. Consulte [Pagos y Créditos](/payments-and-credits) para los detalles del plan.
</Note>
...
Para más información sobre la configuración del temporizador, consulte [Configuración del Temporizador](/timer-settings).
...
- [Configuración del Temporizador](/timer-settings) — Configure temporizadores a nivel de examen y de pregunta
- [Cómo Crear un Cuestionario Socratease](/create-socratease-quiz) — Guía de creación paso a paso
- [Mostrar Resultados a los Candidatos](/show-results-to-candidates) — Controle la visibilidad de los resultados
