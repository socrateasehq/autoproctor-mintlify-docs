...
<Note>
La Importación Masiva está disponible únicamente para clientes del plan **Elite**. Consulte [Funciones Elite](/pricing-account/plans-credits/elite-features) para más detalles.
</Note>
...
<Note>
La Importación Masiva actualmente admite solo los tipos de preguntas **MCQ** y **MCA**. Para otros tipos de preguntas, agréguelas manualmente a través del editor del cuestionario. Consulte [Tipos de Preguntas](/socratease/create-questions/question-types) para la lista completa de formatos disponibles.
</Note>

## Recursos Relacionados

- [Tipos de Preguntas](/socratease/create-questions/question-types) — Todos los formatos de preguntas disponibles
- [Bancos de Preguntas](/socratease/create-questions/question-banks) — Cree conjuntos aleatorios de preguntas a partir de sus preguntas importadas
- [Configuración del Cuestionario](/socratease/settings/quiz-settings) — Configure el comportamiento de su cuestionario
- [Modo de Visualización de Preguntas](/socratease/settings/question-display-mode) — Controle cómo aparecen las preguntas para los candidatos
