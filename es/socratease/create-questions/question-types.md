...
{% hint style="info" %}
No todos los tipos de preguntas están disponibles en todos los planes. Consulte [Disponibilidad de Tipos de Preguntas](socratease/create-questions/question-type-availability.md) para detalles sobre qué tipos están incluidos en su plan.
{% endhint %}

<Frame caption="Tipos de preguntas de Socratease">
  <iframe className="w-full rounded-xl" style={{aspectRatio: "16/9"}} src="https://www.youtube.com/embed/BGubyHnzY_M?rel=0" title="Tipos de preguntas de Socratease" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
</Frame>
...
{% hint style="info" %}
Los siguientes tipos de preguntas requieren un plan **Premium** o **Elite**. Consulte [Disponibilidad de Tipos de Preguntas](socratease/create-questions/question-type-availability.md) para el desglose completo.
{% endhint %}
...
{% hint style="info" %}
Los siguientes tipos de preguntas son exclusivos del plan **Elite**. Consulte [Funciones Elite](pricing-account/plans-credits/elite-features.md) para más información sobre las capacidades del plan Elite.
{% endhint %}
...
- [Bancos de Preguntas](socratease/create-questions/question-banks.md) — Cree conjuntos aleatorios de preguntas
- [Importación Masiva desde Excel](socratease/create-questions/bulk-import-from-excel.md) — Importe preguntas MCQ y MCA de forma masiva
