...
Para más detalles, consulte [Mostrar Resultados a los Candidatos](/socratease/show-results-to-candidates).
...
- [Configuración del Temporizador](/create/timer-settings) — Para la configuración general de temporizador y supervisión del examen (separada de la configuración del cuestionario Socratease)
- [Crear un Cuestionario](/socratease/create-socratease-quiz) — Guía paso a paso para crear un cuestionario
