...
- [¿Dónde Puedo Ver los Resultados de Mi Examen?](/results/how-to-see-results) — Vea los resultados del examen en AutoProctor
- [Exportar a Excel](/results/export-to-excel) — Exporte los resultados de los candidatos a una hoja de cálculo
- [Acceder a Respuestas y Entregas del Candidato](/results/individual-submissions) — Revise las respuestas individuales de los candidatos
