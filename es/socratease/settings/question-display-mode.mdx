...
<Note>
Modo de Visualización de Preguntas es una función **Premium**. Consulte [Pagos y Créditos](/pricing-account/plans-credits/payments-and-credits) para los detalles del plan.
</Note>

## Modos de Visualización

<Frame caption="Configuración del modo de visualización de preguntas en los ajustes del cuestionario">
...
<Frame caption="Modo todas a la vez">
  <img src="/images/socratease/all-at-once.png" alt="Vista del candidato del modo todas a la vez mostrando todas las preguntas en una página" />
</Frame>
...
<Frame caption="Una por una con navegación">
  <img src="/images/socratease/one-by-one-like-typeform.png" alt="Vista del candidato del modo una por una con navegación mostrando una pregunta con botones Siguiente y Anterior" />
</Frame>
...
<Frame caption="Una por una sin navegación">
  <img src="/images/socratease/one-by-one.png" alt="Vista del candidato del modo una por una sin navegación mostrando una pregunta con botones Enviar y Omitir" />
</Frame>
...
Para más información sobre la configuración del temporizador, consulte [Configuración del Temporizador](/tests-results/create/timer-settings).

## Cómo Establecer el Modo de Visualización

<Frame caption="Cómo configurar el modo de visualización de preguntas">
  <video
    controls
...
- [Configuración del Temporizador](/tests-results/create/timer-settings) — Configure temporizadores a nivel de examen y de pregunta
- [Cómo Crear un Cuestionario Socratease](/socratease/create-questions/creating-a-quiz) — Guía de creación paso a paso
- [Mostrar Resultados a los Candidatos](/socratease/settings/showing-results-to-candidates) — Controle la visibilidad de los resultados
