...
- [¿Dónde Puedo Ver los Resultados de Mi Examen?](/tests-results/results/how-to-see-results) — Vea los resultados del examen en AutoProctor
- [Exportar a Excel](/tests-results/results/export-to-excel) — Exporte los resultados de los candidatos a una hoja de cálculo
- [Acceder a Respuestas y Entregas del Candidato](/tests-results/results/individual-submissions) — Revise las respuestas individuales de los candidatos
- [Compartir Resultados del Examen](/tests-results/results/sharing-test-results) — Comparta resultados con otras partes interesadas
