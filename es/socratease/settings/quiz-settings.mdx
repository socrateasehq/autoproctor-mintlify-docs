...
Para más detalles, consulte [Modo de Visualización de Preguntas](/socratease/settings/question-display-mode).
...
Para más detalles, consulte [Mostrar Resultados a los Candidatos](/socratease/settings/showing-results-to-candidates).
...
<Note>
Esta opción solo está disponible cuando usa el modo [Todas a la vez (estilo Google Forms)](/socratease/settings/question-display-mode).
</Note>
...
Para más detalles, consulte [Uso de LaTeX para Ecuaciones Matemáticas](/socratease/settings/latex-math-equations).
...
- [Modo de Visualización de Preguntas](/socratease/settings/question-display-mode) — Explicación detallada de las opciones de visualización
...
- [Uso de LaTeX para Ecuaciones Matemáticas](/socratease/settings/latex-math-equations) — Agregue ecuaciones matemáticas a sus cuestionarios
- [Configuración del Temporizador](/tests-results/create/timer-settings) — Para la configuración general de temporizador y supervisión del examen (separada de la configuración del cuestionario Socratease)
- [Crear un Cuestionario](/socratease/create-questions/creating-a-quiz) — Guía paso a paso para crear un cuestionario
