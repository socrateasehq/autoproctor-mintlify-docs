...
<Note>
La Importación Masiva está disponible únicamente para clientes del plan **Elite**. Consulte [Funciones Elite](/pricing/elite-plan-features) para más detalles.
</Note>
...
<Note>
La Importación Masiva actualmente admite solo los tipos de preguntas **MCQ** y **MCA**. Para otros tipos de preguntas, agréguelas manualmente a través del editor del cuestionario. Consulte [Tipos de Preguntas](/socratease/socratease-question-types) para la lista completa de formatos disponibles.
</Note>
