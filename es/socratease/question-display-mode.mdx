...
<Note>
Modo de Visualización de Preguntas es una función **Premium**. Consulte [Pagos y Créditos](/pricing/payments-and-credits) para los detalles del plan.
</Note>
...
Para más información sobre la configuración del temporizador, consulte [Configuración del Temporizador](/create/timer-settings).
...
- [Configuración del Temporizador](/create/timer-settings) — Configure temporizadores a nivel de examen y de pregunta
- [Cómo Crear un Cuestionario Socratease](/socratease/create-socratease-quiz) — Guía de creación paso a paso
- [Mostrar Resultados a los Candidatos](/socratease/show-results-to-candidates) — Controle la visibilidad de los resultados
