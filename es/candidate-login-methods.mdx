...
<Note>
Para restringir qué candidatos pueden iniciar sesión en su examen, consulte [Restricción por Correo Electrónico](/restrict-access-by-email). Puede limitar el acceso a direcciones de correo electrónico o dominios de correo electrónico específicos.
</Note>

## Recursos Relacionados

- [Cómo Cerrar Sesión](/how-to-logout) -- Cambiar entre cuentas
- [Restricción por Correo Electrónico](/restrict-access-by-email) -- Limitar quién puede acceder a su examen
- [Restricción a Algunos Usuarios](/restrict-access-to-candidates) -- Controlar el acceso al examen para usuarios específicos
- [Invitar Candidatos por Correo Electrónico](/invite-candidates-via-email) -- Enviar invitaciones de examen directamente
- [Página de Instrucciones para Candidatos](/candidate-instructions-page) -- Lo que los candidatos ven antes de comenzar un examen
