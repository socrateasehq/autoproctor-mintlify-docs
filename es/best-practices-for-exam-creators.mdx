...
<Steps>
  ...
  <Step title="Verifique que su cuenta tenga créditos suficientes">
    ...
    Consulte [Pagos y Créditos](/payments-and-credits) para verificar su saldo y comprar más si es necesario.
  ...
  <Step title="Configure la programación del examen con margen adicional">
    ...
    Consulte [Configuración del Temporizador](/timer-settings) para detalles de configuración.
  </Step>
...
<Steps>
  <Step title="Revise los resultados de supervisión">
    Consulte los [Puntajes de Confianza](/what-is-trust-score) y los informes de supervisión de cada candidato. Enfoque su revisión en los candidatos con puntuación inferior al 85%.
  ...
  <Step title="Ayude a los candidatos con problemas técnicos">
    Si los candidatos enfrentan algún problema técnico durante el examen, pídales que sigan [este artículo](/contact-us).
  </Step>
</Steps>
...
- [¿Dónde Puedo Ver los Resultados de Mi Examen?](/where-to-find-quiz-results) — Descripción general de resultados del examen vs. resultados de supervisión
- [Puntaje de Confianza](/what-is-trust-score) — Cómo se calculan los Puntajes de Confianza
- [Configuración de Supervisión](/proctoring-settings) — Configure qué se monitorea durante los exámenes
- [Concurrencia](/max-simultaneous-candidates) — Comprenda los límites de candidatos simultáneos
