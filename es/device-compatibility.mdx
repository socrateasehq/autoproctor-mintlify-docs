...
<Steps>
  <Step title="Abra el enlace del examen de demostración">
    ...
    [Realizar el Examen de Demostración](https://www.autoproctor.co/tests/bj0yv14Ufu/load/)
...
- [El Examen Se Queda en la Pantalla de Carga](/test-stuck-at-loading-screen) — Solucione problemas de carga
- [Examen Lento o con Retrasos](/test-slow-and-laggy) — Solucione problemas de rendimiento
- [Página en Blanco o Pantalla Gris](/blank-screen-during-test) — Resuelva problemas de visualización
- [Instrucciones para Exámenes Supervisados](/take-proctored-exam) — Lo que los candidatos necesitan saber antes de comenzar
- [Mejores Prácticas para Creadores de Exámenes](/best-practices-for-exam-creators) — Consejos incluyendo compartir el examen de demostración con anticipación
