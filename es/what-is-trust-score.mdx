...
AutoProctor monitorea a los candidatos en tiempo real a través de múltiples canales (dependiendo de su [configuración de supervisión](/proctoring-settings)):
...
- [Acceder a Respuestas y Entregas del Candidato](/access-candidate-responses) — Revisión detallada del informe de un candidato individual
- [No Se Detecta Rostro o Se Detectan Múltiples Rostros](/no-face-or-multiple-faces-detected) — Por qué la detección facial puede generar falsos positivos
- [Infracción Falsa de Cambio de Aplicación](/false-app-switch-alert) — Comprenda las señalizaciones de infracciones falsas
- [Mejores Prácticas para Creadores de Exámenes](/best-practices-for-exam-creators) — Consejos para realizar exámenes supervisados eficaces
