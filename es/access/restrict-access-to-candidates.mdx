...
Consulte [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/access/restrict-access-by-email) para instrucciones completas de configuración y ejemplos.
...
Consulte [Invitar Candidatos por Correo Electrónico](/access/invite-candidates-via-email) para el proceso completo de configuración.
...
- [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/access/restrict-access-by-email) — Configure restricciones basadas en dominio y correo electrónico
- [Invitar Candidatos por Correo Electrónico](/access/invite-candidates-via-email) — Genere enlaces de examen únicos por candidato
- [Métodos de Inicio de Sesión del Candidato](/candidate/candidate-login-methods) — Conozca las opciones de autenticación disponibles
- [Configuración Avanzada](/create/advanced-exam-settings) — Configure las Restricciones de Inicio de Sesión y otras opciones avanzadas
