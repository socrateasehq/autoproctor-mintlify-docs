...
<Note>
Esta es una **Función Premium** y requiere una suscripción Premium o Elite. Consulte [Pagos y Créditos](/pricing-account/plans-credits/payments-and-credits) para detalles del plan.
</Note>
...
<Note>
Si necesita datos detallados a nivel de pregunta para Socratease Quizzes, utilice la vista de [entregas individuales](/tests-results/results/individual-submissions) en el [panel de AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>

## Recursos Relacionados

- [Exportar a Excel](/tests-results/results/export-to-excel) -- Descargar resultados manualmente como hoja de cálculo
- [Acceder a Respuestas y Entregas del Candidato](/tests-results/results/individual-submissions) -- Ver respuestas detalladas por candidato
...
- [Pagos y Créditos](/pricing-account/plans-credits/payments-and-credits) -- Detalles del plan y disponibilidad de funciones
