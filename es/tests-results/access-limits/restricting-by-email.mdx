...
- [Métodos de Inicio de Sesión del Candidato](/candidate-guide/attempting/candidate-login-methods) — Conozca las opciones de autenticación disponibles para los candidatos
- [Restringir a Candidatos Específicos](/tests-results/access-limits/restricting-to-some-users) — Otros métodos para limitar el acceso al examen
...
- [Configuración Avanzada](/tests-results/create/advanced-settings) — Configure las Restricciones de Inicio de Sesión y otras opciones avanzadas del examen
