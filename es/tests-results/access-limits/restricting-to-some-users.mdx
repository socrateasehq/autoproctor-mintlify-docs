...
<Frame caption="Campo de Restricciones de Inicio de Sesión con restricciones de dominio y correo electrónico">
  <img src="/images/settings/login-restrictions-email.png" alt="Campo de Restricciones de Inicio de Sesión con restricciones de dominio y correo electrónico" />
</Frame>

Consulte [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/tests-results/access-limits/restricting-by-email) para instrucciones completas de configuración y ejemplos.
...
<Frame caption="Configuración de enlaces de invitación únicos">
...
<Note>
Los enlaces de invitación únicos solo están disponibles en el **Plan Elite** y funcionan con Cuestionarios Socratease y Exámenes con IFrame. Consulte [Pagos y Créditos](/pricing-account/plans-credits/payments-and-credits) para detalles del plan.
</Note>

Consulte [Invitar Candidatos por Correo Electrónico](/tests-results/access-limits/inviting-candidates-via-email) para el proceso completo de configuración.
...
<Steps>
  ...
  <Step title="Restrinja a su organización">
    ...
    <Frame caption="Configuración de restricción de acceso de Google Forms">
      <img src="/images/settings/google-form-restriction.png" alt="Configuración de restricción de acceso de Google Forms" />
    </Frame>
  </Step>
</Steps>
...
- [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/tests-results/access-limits/restricting-by-email) — Configure restricciones basadas en dominio y correo electrónico
- [Invitar Candidatos por Correo Electrónico](/tests-results/access-limits/inviting-candidates-via-email) — Genere enlaces de examen únicos por candidato
- [Métodos de Inicio de Sesión del Candidato](/candidate-guide/attempting/candidate-login-methods) — Conozca las opciones de autenticación disponibles
- [Configuración Avanzada](/tests-results/create/advanced-settings) — Configure las Restricciones de Inicio de Sesión y otras opciones avanzadas
