...
<Steps>
  ...
  <Step title="Pruebe usar el modo Incógnito">
...
- [Instrucciones para Realizar un Examen Supervisado](/candidate-guide/attempting/proctored-test-instructions) -- Sección de Configuración de la Cuenta de Google
- [Instrucciones para Realizar un Examen Cronometrado](/candidate-guide/attempting/timed-test-instructions) -- Sección de Configuración de la Cuenta de Google
</Note>

## Recursos Relacionados

- [No Se Puede Hacer Clic en la Respuesta](/tests-results/issues/cannot-click-answer) -- Problema similar causado por la cuenta de Google incorrecta
...
- [El Examen Se Queda en la Pantalla de Carga](/tests-results/issues/loading-screen) -- Otros problemas de carga
