...
<Frame caption="Formulario del examen cargado en modo de solo lectura debido a una cuenta de Google incorrecta">
  <img className="max-h-[300px] border rounded-xl" src="/images/candidate-issues/cannot-click-form.png" alt="Formulario de Google Forms en AutoProctor en el que no se puede hacer clic porque la cuenta de Google incorrecta está activa" />
</Frame>
...
- [Página en Blanco o Pantalla Gris](/tests-results/issues/blank-page-grey-screen) -- Problema similar causado por la cuenta de Google incorrecta
- [No Se Pueden Ver las Preguntas en Google Forms](/tests-results/issues/google-forms-questions-not-visible) -- Restricciones de acceso a Google Forms
