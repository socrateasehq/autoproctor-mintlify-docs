...
- [Evidencia de Infracciones Faltante](/tests-results/issues/missing-violation-evidence) -- Por qué algunas infracciones carecen de fotos de evidencia
- [Falso 'Cambió a Otra Aplicación'](/tests-results/issues/false-app-switch) -- Otro escenario común de falso positivo
