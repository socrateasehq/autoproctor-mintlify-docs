...
- [Cómo Cerrar Sesión](/candidate-guide/attempting/how-to-logout) -- Cambiar de cuenta si se usó la incorrecta
- [Métodos de Inicio de Sesión para Candidatos](/candidate-guide/attempting/candidate-login-methods) -- Comprenda las opciones de inicio de sesión
