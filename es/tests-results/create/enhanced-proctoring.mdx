...
- [Configuración de Supervisión](/tests-results/create/proctoring-settings) — Opciones básicas de supervisión (cámara, micrófono, cambio de pestaña)
- [Puntaje de Confianza](/understanding/how-proctoring-works/trust-score) — Cómo los datos de supervisión avanzada afectan el puntaje de confianza
- [Resultados de Supervisión](/tests-results/results/proctoring-results) — Revisión de resultados de supervisión avanzada
- [Acceder a Respuestas y Entregas del Candidato](/tests-results/results/individual-submissions) — Visualización de datos detallados para cada candidato
- [Pagos y Créditos](/pricing-account/plans-credits/payments-and-credits) — Comprenda el uso de créditos y las compras
- [Funciones Elite](/pricing-account/plans-credits/elite-features) — Descripción general de las funciones Premium y Elite
