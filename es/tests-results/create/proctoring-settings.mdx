...
<Frame caption="Panel de configuración de supervisión">
...
<Frame caption="Panel de supervisión avanzada">
  <img src="/images/creating-tests/enhanced-proctoring.png" alt="Panel de supervisión avanzada" />
</Frame>
...
<Frame caption="Panel de configuración de comunicación">
  <img className="rounded-xl" src="/images/settings/communication-settings.png" alt="Panel de configuración de comunicación" />
</Frame>
...
- [Supervisión Avanzada](/tests-results/create/enhanced-proctoring) — Guía detallada sobre verificación de identidad, detección de suplantación y supervisión de 360°
...
- [Qué Se Monitorea](/understanding/how-proctoring-works/what-gets-tracked) — Lista completa de todo lo que AutoProctor supervisa
- [Resultados de Supervisión](/tests-results/results/proctoring-results) — Cómo revisar los datos de supervisión después de un examen
- [Puntaje de Confianza](/understanding/how-proctoring-works/trust-score) — Cómo se calcula el puntaje de confianza a partir de los datos de supervisión
