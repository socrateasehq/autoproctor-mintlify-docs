...
<Note>
La Importación Masiva está disponible únicamente para clientes del plan **Elite**. Consulte [Funciones Elite](/elite-plan-features) para más detalles.
</Note>
...
- [Bancos de Preguntas](/question-banks) — Cree conjuntos aleatorios de preguntas a partir de sus preguntas importadas
- [Configuración del Cuestionario](/socratease-quiz-settings) — Configure el comportamiento de su cuestionario
- [Modo de Visualización de Preguntas](/question-display-mode) — Controle cómo aparecen las preguntas para los candidatos
