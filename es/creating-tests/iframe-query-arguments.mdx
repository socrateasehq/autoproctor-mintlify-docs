...
<Steps>
  <Step title="Abra la Configuración Avanzada">
    ...
    {/* TODO: Add screenshot of Advanced Settings with the Query Arguments field visible */}
  </Step>
...
{/* TODO: Add screenshot showing the Query Arguments field with an example value entered */}
