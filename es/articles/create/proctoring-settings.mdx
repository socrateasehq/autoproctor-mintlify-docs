...
- [Supervisión Avanzada](/enhanced-proctoring) — Guía detallada sobre verificación de identidad, detección de suplantación y supervisión de 360°
...
- [Qué Se Monitorea](/what-gets-tracked-during-proctoring) — Lista completa de todo lo que AutoProctor supervisa
- [Resultados de Supervisión](/where-to-find-proctoring-results) — Cómo revisar los datos de supervisión después de un examen
- [Puntaje de Confianza](/what-is-trust-score) — Cómo se calcula el puntaje de confianza a partir de los datos de supervisión
