...
1. **Use la herramienta de cuestionarios propia de AutoProctor ([Socratease](/why-socratease))** — usted crea y configura las preguntas, los puntos y la calificación directamente dentro de AutoProctor.
...
<Steps>
  ...
  <Step title="Configure la Supervisión">
    Configure el [temporizador](/timer-settings) y las [opciones de supervisión](/proctoring-settings). Si eligió Socratease, también configura las preguntas y la calificación dentro de AutoProctor. Para proveedores externos, el contenido del cuestionario permanece en esa plataforma.
  </Step>
</Steps>
...
<Note>
Al usar proveedores IFrame/Otros, puede personalizar la URL incorporada usando [argumentos de consulta](/iframe-query-arguments).
</Note>

## Recursos Relacionados

- [¿Por Qué Socratease?](/why-socratease) — Beneficios de usar la herramienta nativa de cuestionarios de AutoProctor
- [Cómo Crear un Cuestionario de Socratease](/create-socratease-quiz) — Guía de creación paso a paso
...
- [Argumentos de Consulta del IFrame](/iframe-query-arguments) — Personalice las URL de cuestionarios incorporados
- [Configuración Avanzada](/advanced-exam-settings) — Proveedores de inicio de sesión, colaboradores y más
