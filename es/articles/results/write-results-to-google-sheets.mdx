...
<Note>
Esta es una **Función Premium** y requiere una suscripción Premium o Elite. Consulte [Pagos y Créditos](/payments-and-credits) para detalles del plan.
</Note>
...
<Note>
Si necesita datos detallados a nivel de pregunta para Socratease Quizzes, utilice la vista de [entregas individuales](/access-candidate-responses) en el [panel de AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>

## Recursos Relacionados

- [Exportar a Excel](/export-results-to-excel) -- Descargar resultados manualmente como hoja de cálculo
- [Acceder a Respuestas y Entregas del Candidato](/access-candidate-responses) -- Ver respuestas detalladas por candidato
...
- [Pagos y Créditos](/payments-and-credits) -- Detalles del plan y disponibilidad de funciones
