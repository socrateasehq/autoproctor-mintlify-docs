...
1. **Use la herramienta de cuestionarios propia de AutoProctor ([Socratease](/socratease/why-socratease))** — usted crea y configura las preguntas, los puntos y la calificación directamente dentro de AutoProctor.
...
<Steps>
  ...
  <Step title="Configure la Supervisión">
    Configure el [temporizador](/create/timer-settings) y las [opciones de supervisión](/create/proctoring-settings). Si eligió Socratease, también configura las preguntas y la calificación dentro de AutoProctor. Para proveedores externos, el contenido del cuestionario permanece en esa plataforma.
  </Step>
</Steps>
...
<Note>
Al usar proveedores IFrame/Otros, puede personalizar la URL incorporada usando [argumentos de consulta](/create/iframe-query-arguments).
</Note>
...
- [Cómo Crear un Cuestionario de Socratease](/socratease/create-socratease-quiz) — Guía de creación paso a paso
...
- [Argumentos de Consulta del IFrame](/create/iframe-query-arguments) — Personalice las URL de cuestionarios incorporados
- [Configuración Avanzada](/create/advanced-exam-settings) — Proveedores de inicio de sesión, colaboradores y más
