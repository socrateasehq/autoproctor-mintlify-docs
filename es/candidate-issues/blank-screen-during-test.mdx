...
- [Instrucciones para Realizar un Examen Supervisado](/candidate/take-proctored-exam) -- Sección de Configuración de la Cuenta de Google
- [Instrucciones para Realizar un Examen Cronometrado](/candidate/take-timed-exam) -- Sección de Configuración de la Cuenta de Google
</Note>

## Recursos Relacionados

- [No Se Puede Hacer Clic en la Respuesta](/candidate-issues/cannot-click-answers-during-test) -- Problema similar causado por la cuenta de Google incorrecta
...
- [El Examen Se Queda en la Pantalla de Carga](/candidate-issues/test-stuck-at-loading-screen) -- Otros problemas de carga
