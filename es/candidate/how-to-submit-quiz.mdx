...
- [Instrucciones para Exámenes Supervisados](/candidate/take-proctored-exam) -- Guía completa para exámenes supervisados
- [Instrucciones para Exámenes Cronometrados](/candidate/take-timed-exam) -- Guía completa para exámenes cronometrados
- [Instrucciones para Socratease Supervisado](/candidate/take-proctored-socratease-quiz) -- Guía más sencilla para Socratease
- [Respuesta de Google Forms No Visible](/issues/google-forms-response-not-visible) -- Solucionar problemas con envíos faltantes
