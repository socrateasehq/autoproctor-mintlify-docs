...
Consulte [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/restrict-access-by-email) para instrucciones completas de configuración y ejemplos.
...
<Note>
Los enlaces de invitación únicos solo están disponibles en el **Plan Elite** y funcionan con Cuestionarios Socratease y Exámenes con IFrame. Consulte [Pagos y Créditos](/payments-and-credits) para detalles del plan.
</Note>

Consulte [Invitar Candidatos por Correo Electrónico](/invite-candidates-via-email) para el proceso completo de configuración.
...
- [Restringir el Acceso al Examen por Dirección de Correo Electrónico](/restrict-access-by-email) — Configure restricciones basadas en dominio y correo electrónico
- [Invitar Candidatos por Correo Electrónico](/invite-candidates-via-email) — Genere enlaces de examen únicos por candidato
- [Métodos de Inicio de Sesión del Candidato](/candidate-login-methods) — Conozca las opciones de autenticación disponibles
- [Configuración Avanzada](/advanced-exam-settings) — Configure las Restricciones de Inicio de Sesión y otras opciones avanzadas
