...
Para más detalles, consulte [Modo de Visualización de Preguntas](/question-display-mode).
...
Para más detalles, consulte [Mostrar Resultados a los Candidatos](/show-results-to-candidates).
...
<Note>
Esta opción solo está disponible cuando usa el modo [Todas a la vez (estilo Google Forms)](/question-display-mode).
</Note>
...
Para más detalles, consulte [Uso de LaTeX para Ecuaciones Matemáticas](/latex-math-equations).
...
- [Modo de Visualización de Preguntas](/question-display-mode) — Explicación detallada de las opciones de visualización
- [Mostrar Resultados a los Candidatos](/show-results-to-candidates) — Controle la visibilidad de los resultados
- [Uso de LaTeX para Ecuaciones Matemáticas](/latex-math-equations) — Agregue ecuaciones matemáticas a sus cuestionarios
- [Configuración del Temporizador](/timer-settings) — Para la configuración general de temporizador y supervisión del examen (separada de la configuración del cuestionario Socratease)
- [Crear un Cuestionario](/create-socratease-quiz) — Guía paso a paso para crear un cuestionario
