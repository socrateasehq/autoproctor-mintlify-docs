...
- [Configuración de Supervisión](/proctoring-settings) — Opciones básicas de supervisión (cámara, micrófono, cambio de pestaña)
- [Puntaje de Confianza](/what-is-trust-score) — Cómo los datos de supervisión avanzada afectan el puntaje de confianza
- [Resultados de Supervisión](/where-to-find-proctoring-results) — Revisión de resultados de supervisión avanzada
- [Acceder a Respuestas y Entregas del Candidato](/access-candidate-responses) — Visualización de datos detallados para cada candidato
- [Pagos y Créditos](/payments-and-credits) — Comprenda el uso de créditos y las compras
- [Funciones Elite](/elite-plan-features) — Descripción general de las funciones Premium y Elite
