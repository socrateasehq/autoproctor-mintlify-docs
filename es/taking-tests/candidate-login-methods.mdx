...
<Frame>
  <img src="/images/taking-tests/login-methods.png" alt="Opciones de inicio de sesión de AutoProctor mostrando los botones de inicio de sesión con Google, Microsoft y correo electrónico" />
</Frame>
