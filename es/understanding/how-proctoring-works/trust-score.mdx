...
AutoProctor monitorea a los candidatos en tiempo real a través de múltiples canales (dependiendo de su [configuración de supervisión](/tests-results/create/proctoring-settings)):
...
- [Acceder a Respuestas y Entregas del Candidato](/tests-results/results/individual-submissions) — Revisión detallada del informe de un candidato individual
- [No Se Detecta Rostro o Se Detectan Múltiples Rostros](/tests-results/issues/no-face-or-multiple-faces) — Por qué la detección facial puede generar falsos positivos
- [Infracción Falsa de Cambio de Aplicación](/tests-results/issues/false-app-switch) — Comprenda las señalizaciones de infracciones falsas
- [Mejores Prácticas para Creadores de Exámenes](/understanding/getting-started/best-practices-for-teachers) — Consejos para realizar exámenes supervisados eficaces
