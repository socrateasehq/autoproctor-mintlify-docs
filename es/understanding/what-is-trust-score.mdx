...
AutoProctor monitorea a los candidatos en tiempo real a través de múltiples canales (dependiendo de su [configuración de supervisión](/create/proctoring-settings)):
...
- [Acceder a Respuestas y Entregas del Candidato](/results/access-candidate-responses) — Revisión detallada del informe de un candidato individual
- [No Se Detecta Rostro o Se Detectan Múltiples Rostros](/issues/no-face-or-multiple-faces-detected) — Por qué la detección facial puede generar falsos positivos
- [Infracción Falsa de Cambio de Aplicación](/issues/false-app-switch-alert) — Comprenda las señalizaciones de infracciones falsas
- [Mejores Prácticas para Creadores de Exámenes](/understanding/best-practices-for-exam-creators) — Consejos para realizar exámenes supervisados eficaces
