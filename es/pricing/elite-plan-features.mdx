...
Genere un enlace de examen único para cada candidato, de modo que un solo enlace no pueda reenviarse a destinatarios no deseados. Consulte [URL Única por Candidato](/create/advanced-exam-settings#unique-url-per-candidate-elite) para la configuración.

### Instrucciones Adicionales

Agregue instrucciones personalizadas a la página de instrucciones del candidato — útil para compartir reglas específicas, contexto o pautas antes de que comience el examen. Consulte [Instrucciones Adicionales](/create/advanced-exam-settings#additional-instructions-elite) para más detalles.
...
Para la lista completa de tipos de preguntas, consulte [Tipos de Preguntas de Socratease](/socratease/socratease-question-types).

### Importar desde Excel

Usando la plantilla de Excel de AutoProctor, puede **cargar preguntas en masa** a un Cuestionario de Socratease. Esto es ideal para migrar conjuntos de preguntas existentes o crear evaluaciones extensas rápidamente. Consulte [Importación Masiva desde Excel](/socratease/import-questions-from-excel) para instrucciones paso a paso.

## Recursos Relacionados

- [Pagos y Créditos Explicados](/pricing/payments-and-credits) -- Comprenda los niveles de suscripción y los precios
- [¿Qué Es un Equipo?](/pricing/what-is-a-team) -- Comparta la facturación y colabore con los miembros del equipo
- [Tipos de Preguntas](/socratease/socratease-question-types) -- Todos los formatos de preguntas de Socratease disponibles
- [Bancos de Preguntas](/socratease/question-banks) -- Guía detallada para usar bancos de preguntas
- [Importación Masiva desde Excel](/socratease/import-questions-from-excel) -- Instrucciones paso a paso para la importación desde Excel
