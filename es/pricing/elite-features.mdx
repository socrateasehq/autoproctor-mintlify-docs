...
Genere un enlace de examen único para cada candidato, de modo que un solo enlace no pueda reenviarse a destinatarios no deseados. Consulte [URL Única por Candidato](/settings/advanced-settings#unique-url-per-candidate-elite) para la configuración.

### Instrucciones Adicionales

Agregue instrucciones personalizadas a la página de instrucciones del candidato — útil para compartir reglas específicas, contexto o pautas antes de que comience el examen. Consulte [Instrucciones Adicionales](/settings/advanced-settings#additional-instructions-elite) para más detalles.
