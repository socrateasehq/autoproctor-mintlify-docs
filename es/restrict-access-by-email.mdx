...
<Note>
Las restricciones por correo electrónico funcionan en conjunto con el [método de inicio de sesión](/candidate-login-methods) del candidato. El candidato debe iniciar sesión con una dirección de correo electrónico que coincida con uno de los dominios o direcciones permitidos que usted especificó.
</Note>

## Recursos Relacionados

- [Métodos de Inicio de Sesión del Candidato](/candidate-login-methods) — Conozca las opciones de autenticación disponibles para los candidatos
- [Restringir a Candidatos Específicos](/restrict-access-to-candidates) — Otros métodos para limitar el acceso al examen
- [Invitar Candidatos por Correo Electrónico](/invite-candidates-via-email) — Genere enlaces de examen únicos por candidato
- [Configuración Avanzada](/advanced-exam-settings) — Configure las Restricciones de Inicio de Sesión y otras opciones avanzadas del examen
