...
- [Evidencia de Infracciones Faltante](/issues/missing-violation-evidence) -- Por qué algunas infracciones carecen de fotos de evidencia
- [Falso 'Cambió a Otra Aplicación'](/issues/false-app-switch-alert) -- Otro escenario común de falso positivo
