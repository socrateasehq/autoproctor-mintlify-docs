...
<Note>
Los Bancos de Preguntas son una función del plan **Elite**. Necesita una suscripción Elite para crear y usar Bancos de Preguntas y Cuestionarios de Bancos de Preguntas. Consulte [Funciones Elite](/elite-plan-features) para más detalles.
</Note>
...
- [Importación Masiva desde Excel](/import-questions-from-excel) — Importe preguntas de forma masiva para llenar sus Bancos de Preguntas
- [Tipos de Preguntas](/socratease-question-types) — Formatos de preguntas disponibles para usar en los Bancos de Preguntas
- [Uso de Etiquetas](/using-tags) — Organice preguntas con etiquetas para filtrar y agrupar
