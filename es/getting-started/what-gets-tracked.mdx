...
<Frame caption="Tarjetas de evidencia de infracciones mostrando incidentes detectados durante un examen supervisado.">
  <img
    style={{borderRadius: "10px"}}
    src="/images/getting-started/evidence-cards.png"
    alt="Tarjetas de evidencia mostrando cambios de pestaña, detección facial, múltiples rostros, detección de ruido y conteo de múltiples monitores"
  />
</Frame>
