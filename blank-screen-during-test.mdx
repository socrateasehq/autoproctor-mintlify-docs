...
- [Instructions for Taking a Proctored Test](/take-proctored-exam) -- Google Account Setup section
- [Instructions for Taking a Timed Test](/take-timed-exam) -- Google Account Setup section
</Note>

## Related Resources

- [Cannot Click on Answer](/cannot-click-answers-during-test) -- Similar issue caused by wrong Google account
- [Cannot See Questions on Google Forms](/google-forms-questions-not-visible) -- Google Form access issues
- [Test Stuck at Loading Screen](/test-stuck-at-loading-screen) -- Other loading issues
- [How to Logout](/how-to-logout) -- Steps to switch accounts
