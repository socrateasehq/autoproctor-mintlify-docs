...
description: >-
  Understand the key differences in how submission works between Socratease
  quizzes and other quiz types on AutoProctor, and why Socratease eliminates the
  risk of lost answers.
---

# Submit Button: Socratease vs Other Quizzes
...
![Proctored test requiring candidates to click two separate submit buttons](../../.gitbook/assets/submit-buttons-proctored.png) _Other platforms: dual submit buttons_
...
![Socratease quiz showing a single Submit button at the bottom](../../.gitbook/assets/soc-submit-button.png) _Socratease: single submit button_
