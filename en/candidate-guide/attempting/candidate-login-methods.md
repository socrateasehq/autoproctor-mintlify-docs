...
description: >-
  Understand the available login options for candidates taking tests on
  AutoProctor, including which sign-in methods work with each quiz provider.
---
...
![AutoProctor login options showing Google, Microsoft, and Email sign-in buttons](../../.gitbook/assets/login-methods.png) _AutoProctor login screen_
