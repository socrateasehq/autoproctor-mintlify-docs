...
description: >-
  Learn how to access, download, and manage invoices and receipts for all your
  AutoProctor subscription and credit purchases.
---
...
![Sample AutoProctor invoice showing billing details, line items, and total amount](../../.gitbook/assets/sample-invoice.png)

### Frequently Asked Questions

Check your spam or junk folder. If you are part of a Team, the invoice may have been sent to the Team Admin who made the original purchase. You can also download the invoice directly from the \*\*Billing\*\* section. You can update your billing information (company name, address, GST, etc.) from the \*\*Billing\*\* section, but changes only apply to \*\*future invoices\*\*. For amendments to an already-issued invoice, email \*\*hello@autoproctor.co\*\* with the details. Yes. Invoice records are retained even after your subscription expires. You can access them by resubscribing or by contacting support at \*\*hello@autoproctor.co\*\*. AutoProctor generates individual invoices per payment. If you need a consolidated statement, contact support at \*\*hello@autoproctor.co\*\* with your requirements.
