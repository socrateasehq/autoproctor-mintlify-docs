...
{% hint style="info" %}
Bulk Import is available to **Elite Plan** customers only. See [Elite Features](pricing-account/plans-credits/elite-features.md) for details.
{% endhint %}
...
{% endstep %}
{% step %}
### Add Questions to the Excel File
...
{% hint style="info" %}
Bulk Import currently supports **MCQ** and **MCA** question types only. For other question types, add them manually through the quiz editor. See [Question Types](socratease/create-questions/question-types.md) for the full list of available formats.
{% endhint %}

## Related Resources

- [Question Types](socratease/create-questions/question-types.md) -- All available question formats
- [Question Banks](socratease/create-questions/question-banks.md) -- Create randomized question pools from your imported questions
- [Quiz Settings](socratease/settings/quiz-settings.md) -- Configure your quiz behavior
- [Question Display Mode](socratease/settings/question-display-mode.md) -- Control how questions appear to candidates
