...
description: >-
  Control how questions are displayed to candidates -- all at once, one-by-one
  with navigation, or one-by-one without navigation.
---
...
![Question display mode settings panel showing the three available options](../../.gitbook/assets/question-display-mode.png) _Question display mode setting in quiz settings_
...
![Candidate view of all-at-once display mode showing all questions on one page](../../.gitbook/assets/all-at-once.png) _All-at-once display mode_
...
![Candidate view of one-by-one with navigation display mode showing a single question with Next and Previous buttons](../../.gitbook/assets/one-by-one-like-typeform.png) _One-by-one with navigation_
...
![Candidate view of one-by-one without navigation display mode showing a single question with Submit and Skip buttons](../../.gitbook/assets/one-by-one.png) _One-by-one without navigation_
