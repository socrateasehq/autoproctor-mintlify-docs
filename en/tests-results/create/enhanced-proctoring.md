...
description: >-
  Set up ID card verification, impersonation detection, 360-degree proctoring,
  session recording, and candidate video recording for advanced anti-cheating
  protection.
---
...
![Enhanced proctoring settings panel](../../.gitbook/assets/enhanced-proctoring.png)
...
![ID verification screen before test start](../../.gitbook/assets/id-verification.png) _ID verification screen before test start_
...
![Impersonation evidence on report](../../.gitbook/assets/impersonation-detected.png) _Impersonation evidence on report_
...
![Auxiliary device pairing screen before test start](../../.gitbook/assets/aux-device.png) _Auxiliary device pairing screen before test start_
{% endstep %}
...
![Auxiliary device evidence captures](../../.gitbook/assets/aux-device-evidence.png) _Auxiliary device evidence captures_
