...
description: >-
  Configure login providers, email restrictions, Google Sheets integration,
  collaborators, and other advanced test options.
---
...
![Advanced settings configuration panel](../../.gitbook/assets/advanced-settings.png) _Advanced settings configuration panel_
