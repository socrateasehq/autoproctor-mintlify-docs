...
description: >-
  Configure tab switching detection, camera monitoring, microphone recording,
  full screen enforcement, and other proctoring options.
---
...
![Proctoring settings panel](../../.gitbook/assets/proctoring-settings.png) _Proctoring settings panel_
...
![Communication settings panel](../../.gitbook/assets/communication-settings.png) _Communication settings panel_
