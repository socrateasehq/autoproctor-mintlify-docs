...
{% endstep %}
{% step %}
### Configure Auto-Submit (Optional)
...
{% endstep %}
{% step %}
### Set a Submission Deadline (Optional)
...
{% endstep %}
{% step %}
### Configure Buffer Time (Optional)
...
- [Proctoring Settings](tests-results/create/proctoring-settings.md) — Configure camera, microphone, and tab-switching detection
- [Advanced Settings](tests-results/create/advanced-settings.md) — Login providers, restrictions, and integrations
- [Quiz Settings](socratease/settings/quiz-settings.md) — For Socratease quiz-specific settings, see the Socratease Quiz Settings page
- [Resuming Test Attempts](tests-results/create/resuming-test-attempts.md) — How auto-resume works with timed tests
- [What Gets Tracked](understanding/how-proctoring-works/what-gets-tracked.md) — Overview of all proctoring capabilities
