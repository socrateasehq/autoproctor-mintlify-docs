...
description: >-
  Understand the two types of results available on AutoProctor -- quiz results
  showing candidate performance and proctoring results tracking integrity.
---
...
![AutoProctor results page showing Trust Score column for each candidate](../../.gitbook/assets/sample-results.png) _Results page showing Trust Score column_
