...
![Green Submit button that candidates must click after submitting the test](images/results/click-after-submitting.png)
*The green Submit button candidates must click*
...
![Results page showing submitted and unsubmitted tests with Hide unsubmitted button](images/results/results-hide-unsubmitted.png)
*Results page showing unsubmitted tests*
...
![Results page showing only submitted tests with Show unsubmitted button](images/results/results-show-unsubmitted.png)
*Results page with unsubmitted tests hidden*
...
![Proctoring report showing the test has not been marked as finished yet with a Mark as Finished button](images/results/mark-as-finished.png)
*Proctoring report for an unsubmitted test*
...
![Confirmation dialog showing the test has been marked as finished](images/results/mark-as-finished-redirection-swal.png)
*Confirmation after marking a test as finished*
...
![Individual results page showing all questions as Not Attempted for an unsubmitted test](images/results/unattempted-indivisual-result-page.png)
*Quiz answers for an unsubmitted test*
