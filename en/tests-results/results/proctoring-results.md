...
description: >-
  Access and review proctoring results for your tests on AutoProctor, including
  Trust Scores, violation details, and candidate-level reports.
---

# Where Can I See Proctoring Results?
...
![Results button highlighted on the AutoProctor dashboard](../../.gitbook/assets/results-button-dashboard.png) _Results button on the AutoProctor dashboard_
{% endstep %}
...
![Results table showing candidate submissions with Trust Scores](../../.gitbook/assets/results-table.png) _Results table_
{% endstep %}
...
![Proctoring summary page showing detected violations and evidence](../../.gitbook/assets/proctoring-summary.png) _Proctoring summary page_
{% endstep %}
{% endstepper %}
