...
description: >-
  Download your AutoProctor test results as an Excel spreadsheet for
  record-keeping, sharing with colleagues, and audit purposes.
---
...
![Results table on the AutoProctor dashboard with export option](../../.gitbook/assets/export-results-table.png) _Results table with Export to Excel button_
...
![GIF showing how to export results to Excel from the AutoProctor dashboard](../../.gitbook/assets/export-results-to-excel.gif) _Exporting results to Excel_
