...
description: >-
  Set up automatic export of AutoProctor test results to Google Sheets so data
  flows in real time without manual downloads.
---
...
![GIF showing how to set up Google Sheets integration in AutoProctor](../../.gitbook/assets/write-to-gsheet.gif) _Setting up Google Sheets integration_
