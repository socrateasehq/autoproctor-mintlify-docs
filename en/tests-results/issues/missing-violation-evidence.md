...
The test administrator may have disabled evidence storage through the test's proctoring configuration. Check your [proctoring settings](tests-results/create/proctoring-settings.md) to confirm that evidence recording is enabled.
...
- [Missing Images and Recordings](tests-results/issues/missing-images-and-recordings.md) -- Evidence missing from reports
