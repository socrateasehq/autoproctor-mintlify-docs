...
description: >-
  Resolve blank page or grey screen issues when loading a proctored test.
  Usually caused by being signed into the wrong Google account.
---

# Blank Page or Grey Screen During Test
...
![Blank page displayed when the wrong Google account is active in AutoProctor](../../.gitbook/assets/blank-page-google-account.png) _Blank page caused by being signed into the wrong Google account_
