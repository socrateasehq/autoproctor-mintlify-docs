...
description: >-
  Fix incorrect candidate names showing in the results page or Excel export.
  Names are pulled from the candidate's linked Google or Microsoft account
  profile.
---
...
![Incorrect candidate name shown in AutoProctor results page](../../.gitbook/assets/incorrect-student-name.png) _Example of an incorrect candidate name displayed in AutoProctor results_
