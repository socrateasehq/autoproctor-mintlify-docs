...
description: >-
  Fix the issue where your test form loads but you cannot click on questions or
  select answers. Usually caused by being signed into the wrong Google account.
---

# Cannot Click on Answers in Test Form
...
![Google Form in AutoProctor that cannot be clicked because the wrong Google account is active](../../.gitbook/assets/cannot-click-form.png) _Test form loaded in read-only mode due to incorrect Google account_
