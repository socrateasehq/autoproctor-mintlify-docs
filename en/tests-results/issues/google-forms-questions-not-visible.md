...
description: >-
  Understand why questions may not be visible on a Google Form loaded through
  AutoProctor and how to resolve access restriction errors.
---

# Cannot See Questions on Google Forms
...
![Google Form displaying access restricted error inside AutoProctor interface](../../.gitbook/assets/google-forms-access-restricted.png) _Google Form showing an access restriction message within AutoProctor_
