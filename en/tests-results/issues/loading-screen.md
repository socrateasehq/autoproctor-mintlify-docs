...
description: >-
  Fix tests that are stuck on the loading screen. Learn why device or browser
  compatibility issues cause loading failures and how to resolve them.
---
...
![AutoProctor loading screen stuck due to device or browser compatibility issue](../../.gitbook/assets/loading-screen-demo.png) _AutoProctor loading screen indicating a compatibility issue_
