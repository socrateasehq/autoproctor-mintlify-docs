...
- [Missing Violation Evidence](tests-results/issues/missing-violation-evidence.md) -- Why some violations lack evidence photos
- [False 'Switched to Different Application'](tests-results/issues/false-app-switch.md) -- Another common false positive scenario
