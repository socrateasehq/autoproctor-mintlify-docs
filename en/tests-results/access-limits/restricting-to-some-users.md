...
description: >-
  Limit test participation to specific candidates on AutoProctor using link
  distribution, email restrictions, unique invitation links, or platform access
  controls.
---
...
![Login Restrictions field with domain and email restrictions](../../.gitbook/assets/login-restrictions-email.png) _Login Restrictions field with domain and email restrictions_
...
![Google Forms access restriction settings](../../.gitbook/assets/google-form-restriction.png) _Google Forms access restriction settings_
{% endstep %}
{% endstepper %}
