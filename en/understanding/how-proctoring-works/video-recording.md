...
description: >-
  Learn how AutoProctor monitors candidates in real time without recording full
  video sessions, and why this approach is more effective.
---
...
![Proctoring report displaying photos, screenshots, audio clips, and activity logs as violation evidence](../../.gitbook/assets/sample-proctoring-report.png) _A proctoring report showing different types of violation evidence_
