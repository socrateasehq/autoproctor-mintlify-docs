...
description: >-
  Follow these best practices when administering proctored tests on AutoProctor
  to ensure a smooth experience for you and your candidates.
---

# Best Practices for Test Creators
...
![AutoProctor dashboard showing the account credits and balance display](../../.gitbook/assets/display-credits.gif) _Account credits display on the AutoProctor dashboard_
{% endstep %}
