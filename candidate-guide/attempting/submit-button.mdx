...
<Note>
Socratease Quizzes are available on **all plans**, including the free trial. See [Why Socratease?](/socratease/create-questions/why-socratease) for more benefits.
</Note>
...
- [Proctored Test Instructions](/candidate-guide/attempting/proctored-test-instructions) -- Full guide for proctored tests
- [Timed Test Instructions](/candidate-guide/attempting/timed-test-instructions) -- Full guide for timed tests
- [Proctored Socratease Instructions](/candidate-guide/attempting/proctored-socratease-instructions) -- Simpler guide for Socratease
- [Google Forms Response Not Visible](/tests-results/issues/google-forms-response-not-visible) -- Troubleshoot missing submissions
- [Why Socratease?](/socratease/create-questions/why-socratease) -- Benefits of using Socratease over Google Forms
