...
<Note>
To restrict which candidates can log in to your test, see [Restricting by Email](/tests-results/access-limits/restricting-by-email). You can limit access to specific email addresses or email domains.
</Note>

## Related Resources

- [How to Logout](/candidate-guide/attempting/how-to-logout) -- Switch between accounts
- [Restricting by Email](/tests-results/access-limits/restricting-by-email) -- Limit who can access your test
- [Restricting to Some Users](/tests-results/access-limits/restricting-to-some-users) -- Control test access for specific users
- [Inviting Candidates via Email](/tests-results/access-limits/inviting-candidates-via-email) -- Send test invitations directly
- [Instructions Page for Candidates](/tests-results/create/instructions-page-for-candidates) -- What candidates see before starting a test
