...
<Note>
If you are part of a [Team](/pricing-account/billing-teams/teams), the Team Admin receives the confirmation emails, even if you made the payment from your own account.
</Note>
...
<Steps>
  ...
  <Step title="Verify your payment method">
    Confirm that the credit card on file is valid and has sufficient funds. You can update it via [Editing Billing Information](/pricing-account/billing-teams/billing-information).
  </Step>
...
On AutoProctor, you can join and leave a [Team](/pricing-account/billing-teams/teams). If you are part of a team, you share the subscription and credit balance with other team members.
...
- [Track Test Pack Usage](/pricing-account/billing-teams/track-test-pack-usage) -- Monitor your credit consumption
- [What is a Team?](/pricing-account/billing-teams/teams) -- Understand team billing and shared credits
- [Editing Billing Information](/pricing-account/billing-teams/billing-information) -- Update your payment method
- [Contact Us](/pricing-account/support/contact-us) -- Reach AutoProctor support
