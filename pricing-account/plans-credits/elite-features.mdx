...
Generate a unique test link for each candidate so a single link cannot be forwarded to unintended recipients. See [Unique URL per Candidate](/tests-results/create/advanced-settings#unique-url-per-candidate-elite) for setup.

### Additional Instructions

Add custom instructions to the candidate instructions page — useful for sharing specific rules, context, or guidelines before the test begins. See [Additional Instructions](/tests-results/create/advanced-settings#additional-instructions-elite) for details.
...
For a detailed guide, see [Question Banks](/socratease/create-questions/question-banks).
...
For the full list of question types, see [Socratease Question Types](/socratease/create-questions/question-types).

### Import From Excel

Using the AutoProctor Excel template, you can **bulk upload questions** onto a Socratease Quiz. This is ideal for migrating existing question sets or creating large assessments quickly. See [Bulk Import from Excel](/socratease/create-questions/bulk-import-from-excel) for step-by-step instructions.

## Related Resources

- [Payments and Credits Explained](/pricing-account/plans-credits/payments-and-credits) -- Understand subscription tiers and pricing
- [What is a Team?](/pricing-account/billing-teams/teams) -- Share billing and collaborate with team members
- [Question Types](/socratease/create-questions/question-types) -- All available Socratease question formats
- [Question Banks](/socratease/create-questions/question-banks) -- Detailed guide to using question banks
- [Bulk Import from Excel](/socratease/create-questions/bulk-import-from-excel) -- Step-by-step Excel import instructions
- [Why Socratease](/socratease/create-questions/why-socratease) -- Benefits of using Socratease over other quiz platforms
