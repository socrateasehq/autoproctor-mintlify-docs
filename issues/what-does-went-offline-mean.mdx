...
- [What Gets Tracked](/understanding/what-gets-tracked-during-proctoring) -- All events AutoProctor monitors
- [Proctoring Results](/results/where-to-find-proctoring-results) -- How to review proctoring reports
- [Test is Slow and Laggy](/candidate-issues/test-slow-and-laggy) -- Performance issues that may relate to connectivity
