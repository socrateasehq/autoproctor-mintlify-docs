...
- [Missing Violation Evidence](/issues/missing-violation-evidence) -- Why some violations lack evidence photos
- [False 'Switched to Different Application'](/issues/false-app-switch-alert) -- Another common false positive scenario
