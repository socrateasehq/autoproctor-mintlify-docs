...
The test administrator may have disabled evidence storage through the test's proctoring configuration. Check your [proctoring settings](/create/proctoring-settings) to confirm that evidence recording is enabled.

{/* TODO: Add screenshot of proctoring settings showing evidence recording toggle */}

## Related Resources

- [Proctoring Results](/results/where-to-find-proctoring-results) -- How to review proctoring reports
- [Understanding Trust Score](/understanding/what-is-trust-score) -- How Trust Scores are calculated
- [Missing Random Photos](/issues/missing-random-photos) -- Why random photos may be absent
- [Missing Images and Recordings](/issues/missing-images-and-recordings) -- Evidence missing from reports
- [Proctoring Settings](/create/proctoring-settings) -- Configure evidence storage and proctoring options
