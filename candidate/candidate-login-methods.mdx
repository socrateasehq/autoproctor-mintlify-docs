...
<Note>
To restrict which candidates can log in to your test, see [Restricting by Email](/access/restrict-access-by-email). You can limit access to specific email addresses or email domains.
</Note>

## Related Resources

- [How to Logout](/candidate/how-to-logout) -- Switch between accounts
- [Restricting by Email](/access/restrict-access-by-email) -- Limit who can access your test
- [Restricting to Some Users](/access/restrict-access-to-candidates) -- Control test access for specific users
- [Inviting Candidates via Email](/access/invite-candidates-via-email) -- Send test invitations directly
- [Instructions Page for Candidates](/create/candidate-instructions-page) -- What candidates see before starting a test
