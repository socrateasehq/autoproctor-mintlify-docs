...
<Note>
Os Bancos de Perguntas são um recurso do plano **Elite**. Você precisa de uma assinatura Elite para criar e usar Bancos de Perguntas e Questionários de Bancos de Perguntas. Consulte [Recursos Elite](/pricing/elite-plan-features) para detalhes.
</Note>
...
- [Importação em Massa a partir de Excel](/socratease/import-questions-from-excel) — Importe perguntas em massa para popular seus Bancos de Perguntas
- [Tipos de Perguntas](/socratease/socratease-question-types) — Formatos de perguntas disponíveis para uso nos Bancos de Perguntas
