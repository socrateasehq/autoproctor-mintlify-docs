...
<Frame caption="Visão geral dos Questionários de Banco de Perguntas criados.">
  <img src="/images/socratease/question-bank-quiz-overview.png" alt="Visão geral dos Questionários de Banco de Perguntas mostrando QBPs criados com contagem de respostas" />
</Frame>
...
<Frame caption="Como criar um Questionário de Banco de Perguntas.">
  <video
    controls
