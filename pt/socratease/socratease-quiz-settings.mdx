...
Para mais detalhes, consulte [Mostrar Resultados aos Candidatos](/socratease/show-results-to-candidates).
...
- [Configurações de Tempo](/create/timer-settings) — Para configuração geral do temporizador e supervisão do teste (separada das configurações do questionário Socratease)
- [Criar um Questionário](/socratease/create-socratease-quiz) — Guia passo a passo para criar um questionário
