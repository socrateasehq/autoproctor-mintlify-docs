...
Para mais detalhes, consulte [Modo de Exibição de Perguntas](/socratease/settings/question-display-mode).
...
Para mais detalhes, consulte [Mostrar Resultados aos Candidatos](/socratease/settings/showing-results-to-candidates).
...
<Note>
Esta opção está disponível apenas quando você usa o modo [Todas de uma vez (estilo Google Forms)](/socratease/settings/question-display-mode).
</Note>
...
Para mais detalhes, consulte [Uso de LaTeX para Equações Matemáticas](/socratease/settings/latex-math-equations).
...
- [Modo de Exibição de Perguntas](/socratease/settings/question-display-mode) — Explicação detalhada das opções de exibição
...
- [Uso de LaTeX para Equações Matemáticas](/socratease/settings/latex-math-equations) — Adicione equações matemáticas aos seus questionários
- [Configurações de Tempo](/tests-results/create/timer-settings) — Para configuração geral do temporizador e supervisão do teste (separada das configurações do questionário Socratease)
- [Criar um Questionário](/socratease/create-questions/creating-a-quiz) — Guia passo a passo para criar um questionário
