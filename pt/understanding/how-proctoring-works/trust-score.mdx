...
O AutoProctor monitora os candidatos em tempo real por meio de múltiplos canais (dependendo das suas [configurações de supervisão](/tests-results/create/proctoring-settings)):
...
- [Envios Individuais](/tests-results/results/individual-submissions) — Revisando o relatório de um candidato em detalhes
- [Nenhum Rosto ou Múltiplos Rostos Detectados](/tests-results/issues/no-face-or-multiple-faces) — Por que a detecção facial pode gerar falsos positivos
- [Infração Falsa de Troca de Aplicativo](/tests-results/issues/false-app-switch) — Entendendo as sinalizações de infrações falsas
- [Boas Práticas para Criadores de Testes](/understanding/getting-started/best-practices-for-teachers) — Dicas para aplicar testes supervisionados de forma eficaz
