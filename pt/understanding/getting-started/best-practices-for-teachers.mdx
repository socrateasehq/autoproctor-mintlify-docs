...
| **Telegram, Facebook, WhatsApp** | Não | Os navegadores internos dos aplicativos são frequentemente incompatíveis com a supervisão do AutoProctor. Se você compartilhar o link por aqui, peça aos candidatos que o copiem e o abram no Chrome ou Firefox |
