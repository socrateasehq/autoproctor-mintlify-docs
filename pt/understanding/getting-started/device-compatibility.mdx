...
- [Teste Lento e com Travamentos](/tests-results/issues/slow-and-laggy) — Corrija problemas de desempenho
- [Página em Branco ou Tela Cinza](/tests-results/issues/blank-page-grey-screen) — Resolva problemas de exibição
- [Instruções para Testes Supervisionados](/candidate-guide/attempting/proctored-test-instructions) — O que os candidatos precisam saber antes de começar
- [Boas Práticas para Criadores de Testes](/understanding/getting-started/best-practices-for-teachers) — Dicas incluindo o compartilhamento do teste de demonstração com antecedência
