...
<Steps>
  ...
  <Step title="Configure o tempo do teste com margem de tolerância">
    ...
    Consulte [Configurações de Tempo](/create/timer-settings) para detalhes de configuração.
  </Step>
...
<Steps>
  <Step title="Revise os resultados de supervisão">
    Verifique os [Trust Scores](/understanding/what-is-trust-score) e os relatórios de supervisão de cada candidato. Concentre sua revisão nos candidatos com pontuação inferior a 85%.
  ...
  <Step title="Ajude os candidatos com problemas técnicos">
    Se os candidatos enfrentarem algum problema técnico durante o teste, peça que sigam [este artigo](/pricing/contact-us).
  </Step>
</Steps>

## Recursos Relacionados

- [Coisas que Você Precisa Saber](/understanding/before-you-get-started) — Requisitos essenciais para usar o AutoProctor
...
- [Trust Score](/understanding/what-is-trust-score) — Como os Trust Scores são calculados
- [Configurações de Supervisão](/create/proctoring-settings) — Configure o que é monitorado durante os testes
- [Concorrência](/access/max-simultaneous-candidates) — Entenda os limites de candidatos simultâneos
