...
- [Teste Lento e com Travamentos](/candidate-issues/test-slow-and-laggy) — Corrija problemas de desempenho
- [Página em Branco ou Tela Cinza](/candidate-issues/blank-screen-during-test) — Resolva problemas de exibição
- [Instruções para Testes Supervisionados](/candidate/take-proctored-exam) — O que os candidatos precisam saber antes de começar
- [Boas Práticas para Criadores de Testes](/understanding/best-practices-for-exam-creators) — Dicas incluindo o compartilhamento do teste de demonstração com antecedência
