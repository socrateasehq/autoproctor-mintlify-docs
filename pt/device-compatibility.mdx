...
<Steps>
  <Step title="Abra o link do teste de demonstração">
    ...
    [Fazer o Teste de Demonstração](https://www.autoproctor.co/tests/bj0yv14Ufu/load/)
...
- [Teste Lento e com Travamentos](/test-slow-and-laggy) — Corrija problemas de desempenho
- [Página em Branco ou Tela Cinza](/blank-screen-during-test) — Resolva problemas de exibição
- [Instruções para Testes Supervisionados](/take-proctored-exam) — O que os candidatos precisam saber antes de começar
- [Boas Práticas para Criadores de Testes](/best-practices-for-exam-creators) — Dicas incluindo o compartilhamento do teste de demonstração com antecedência
