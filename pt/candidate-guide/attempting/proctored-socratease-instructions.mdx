...
<Steps>
  ...
  <Step title="Solucione problemas se necessário">
    Se a demonstração não carregar, seu dispositivo pode não atender aos requisitos mínimos. Consulte [Compatibilidade de Dispositivos](/understanding/getting-started/device-compatibility) para a lista completa de configurações compatíveis.
  </Step>
</Steps>
...
- [Instruções para Socratease Cronometrado](/candidate-guide/attempting/timed-socratease-instructions) — Instruções para questionários Socratease sem supervisão
