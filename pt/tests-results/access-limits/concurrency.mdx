...
Se você precisa de limites de concorrência mais altos, [entre em contato com a equipe do AutoProctor](/pricing-account/support/contact-us):
...
- [Pagamentos e Créditos](/pricing-account/plans-credits/payments-and-credits) — Detalhes do plano e informações de preços
...
- [Fale Conosco](/pricing-account/support/contact-us) — Entre em contato com a equipe do AutoProctor para aumentos de limite
