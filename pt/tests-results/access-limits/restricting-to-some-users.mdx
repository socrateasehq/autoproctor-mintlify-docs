...
Consulte [Restringir o Acesso ao Teste por Endereço de E-mail](/tests-results/access-limits/restricting-by-email) para instruções completas de configuração e exemplos.
...
<Steps>
  ...
  <Step title="Gere os links únicos">
...
<Note>
Os links de convite únicos estão disponíveis apenas no **Plano Elite** e funcionam com Socratease Quizzes e Testes IFrame. Consulte [Pagamentos e Créditos](/pricing-account/plans-credits/payments-and-credits) para detalhes do plano.
</Note>

Consulte [Convidar Candidatos por E-mail](/tests-results/access-limits/inviting-candidates-via-email) para o processo completo de configuração.
...
- [Restringir o Acesso ao Teste por Endereço de E-mail](/tests-results/access-limits/restricting-by-email) — Configure restrições baseadas em domínio e e-mail
- [Convidar Candidatos por E-mail](/tests-results/access-limits/inviting-candidates-via-email) — Gere links de teste únicos por candidato
- [Métodos de Login do Candidato](/candidate-guide/attempting/candidate-login-methods) — Conheça as opções de autenticação disponíveis
- [Configurações Avançadas](/tests-results/create/advanced-settings) — Configure Restrições de Login e outras opções avançadas
- [Boas Práticas para Criadores de Testes](/understanding/getting-started/best-practices-for-teachers) — Dicas para uma administração de testes tranquila
