...
- [Não Consigo Ver a Resposta no Google Forms](/tests-results/issues/google-forms-response-not-visible) -- Respostas ausentes após o envio
- [Não Consigo Clicar na Resposta](/tests-results/issues/cannot-click-answer) -- O formulário carrega mas não é interativo
- [Página em Branco ou Tela Cinza](/tests-results/issues/blank-page-grey-screen) -- O formulário não carrega de forma alguma
- [Instruções para Testes Supervisionados](/candidate-guide/attempting/proctored-test-instructions) -- Guia de configuração com seção de Conta Google
