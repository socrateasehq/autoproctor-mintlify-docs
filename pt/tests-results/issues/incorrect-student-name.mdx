...
<Frame caption="Exemplo de um nome incorreto de candidato exibido nos resultados do AutoProctor">
  <img className="border rounded-xl" src="/images/candidate-issues/incorrect-student-name.png" alt="Nome incorreto do candidato mostrado na página de resultados do AutoProctor" />
</Frame>
...
- [Como Fazer Logout](/candidate-guide/attempting/how-to-logout) -- Troque de conta se a conta errada foi usada
- [Métodos de Login do Candidato](/candidate-guide/attempting/candidate-login-methods) -- Entenda as opções de login
