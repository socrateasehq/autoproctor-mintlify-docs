...
O administrador do teste pode ter desativado o armazenamento de evidência através da configuração de supervisão do teste. Verifique suas [configurações de supervisão](/tests-results/create/proctoring-settings) para confirmar que a gravação de evidência está ativada.
...
- [Imagens e Gravações Ausentes](/tests-results/issues/missing-images-and-recordings) -- Evidência ausente nos relatórios
