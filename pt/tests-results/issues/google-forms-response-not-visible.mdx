...
<Frame caption="Os dois botões de envio: roxo para o Google Forms, verde para o AutoProctor">
  <img className="max-h-[300px] border rounded-xl" src="/images/taking-tests/submit-buttons-proctored.png" alt="Botão de envio roxo do Google Forms e botão de envio verde do AutoProctor mostrados em um teste supervisionado" />
</Frame>
...
<Note>
Para evitar a confusão com dois botões de envio, considere usar [questionários Socratease](/socratease/create-questions/why-socratease) em vez do Google Forms. O Socratease tem um único botão de envio que gerencia tanto as respostas do questionário quanto a supervisão em uma única etapa.
</Note>

## Recursos Relacionados

- [Diferenças do Botão de Envio](/candidate-guide/attempting/submit-button) -- Comparação completa entre Socratease e outros tipos de questionários
