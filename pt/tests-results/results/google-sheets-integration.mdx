...
<Note>
Esta é uma **Funcionalidade Premium** e requer uma assinatura Premium ou Elite. Consulte [Pagamentos e Créditos](/pricing-account/plans-credits/payments-and-credits) para detalhes dos planos.
</Note>
...
<Note>
Se você precisa de dados detalhados por pergunta para Questionários Socratease, use a visualização de [submissões individuais](/tests-results/results/individual-submissions) no [painel do AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>

## Recursos Relacionados

- [Exportar para Excel](/tests-results/results/export-to-excel) -- Baixe resultados manualmente como planilha
- [Acessar Respostas e Entregas do Candidato](/tests-results/results/individual-submissions) -- Veja respostas detalhadas por candidato
...
- [Pagamentos e Créditos](/pricing-account/plans-credits/payments-and-credits) -- Detalhes dos planos e disponibilidade de funcionalidades
- [Compartilhar Resultados do Teste](/tests-results/results/sharing-test-results) -- Conceda acesso aos resultados do teste para outros usuários
