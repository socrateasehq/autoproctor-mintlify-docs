...
<Note>
Para exportações automáticas e contínuas sem downloads manuais, considere configurar a [integração com Google Sheets](/tests-results/results/google-sheets-integration).
</Note>

## Recursos Relacionados

- [Integração com Google Sheets](/tests-results/results/google-sheets-integration) -- Escreva resultados automaticamente em uma planilha Google
...
- [Onde Posso Ver os Resultados de Supervisão?](/tests-results/results/proctoring-results) -- Veja relatórios detalhados de supervisão
