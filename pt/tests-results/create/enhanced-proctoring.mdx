...
- [Configurações de Supervisão](/tests-results/create/proctoring-settings) — Opções básicas de supervisão (câmera, microfone, troca de aba)
- [Trust Score](/understanding/how-proctoring-works/trust-score) — Como os dados de supervisão avançada afetam o Trust Score
- [Resultados de Supervisão](/tests-results/results/proctoring-results) — Revisando os resultados de supervisão avançada
- [Envios Individuais](/tests-results/results/individual-submissions) — Visualizando dados detalhados de cada candidato
- [Pagamentos e Créditos](/pricing-account/plans-credits/payments-and-credits) — Entendendo o uso e a compra de créditos
- [Recursos Elite](/pricing-account/plans-credits/elite-features) — Visão geral dos recursos Premium e Elite
