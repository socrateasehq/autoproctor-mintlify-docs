...
<Steps>
  ...
  <Step title="Desative a retomada automática no AutoProctor">
    ...
    {/* TODO: Add screenshot of AutoProctor test settings showing Enable Auto-resume toggled OFF */}

    <Frame>
      <img src="/images/settings/gforms-autoresume-disabled.png" alt="Configurações do teste do AutoProctor mostrando Enable Auto-resume desativado" />
    </Frame>
  </Step>
</Steps>
...
- [Retomar Tentativas de Teste](/tests-results/create/resuming-test-attempts) — Comportamento geral de retomada em todos os tipos de teste
- [Tentativas Máximas](/tests-results/access-limits/maximum-attempts) — Configure quantas tentativas os candidatos podem realizar
- [Testes Não Enviados](/tests-results/results/unsubmitted-tests) — Veja testes iniciados mas não enviados
