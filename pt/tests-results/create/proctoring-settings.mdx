...
- [Supervisão Avançada](/tests-results/create/enhanced-proctoring) — Guia detalhado sobre verificação de identidade, detecção de impostor e supervisão em 360°
...
- [O Que é Monitorado](/understanding/how-proctoring-works/what-gets-tracked) — Lista completa de tudo o que o AutoProctor monitora
- [Resultados de Supervisão](/tests-results/results/proctoring-results) — Como revisar os dados de supervisão após um teste
- [Trust Score](/understanding/how-proctoring-works/trust-score) — Como o Trust Score é calculado a partir dos dados de supervisão
