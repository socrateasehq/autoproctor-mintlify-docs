...
1. **Use a ferramenta de questionários própria do AutoProctor ([Socratease](/socratease/create-questions/why-socratease))** — você cria e configura as perguntas, a pontuação e a correção diretamente dentro do AutoProctor.
...
<Steps>
  ...
  <Step title="Configure a Supervisão">
    Configure as definições de [tempo](/tests-results/create/timer-settings) e [supervisão](/tests-results/create/proctoring-settings). Se você escolheu o Socratease, também configura as perguntas e a correção dentro do AutoProctor. Para provedores externos, o conteúdo do questionário permanece nessa plataforma.
  </Step>
</Steps>
...
<Note>
Ao usar provedores IFrame/Other, você pode personalizar a URL incorporada usando [argumentos de consulta](/tests-results/create/iframe-query-arguments).
</Note>

## Recursos Relacionados

- [Por Que Socratease?](/socratease/create-questions/why-socratease) — Benefícios de usar a ferramenta nativa de questionários do AutoProctor
- [Como Criar um Questionário do Socratease](/socratease/create-questions/creating-a-quiz) — Guia de criação passo a passo
...
- [Argumentos de Consulta do IFrame](/tests-results/create/iframe-query-arguments) — Personalize as URLs de questionários incorporados
- [Configurações Avançadas](/tests-results/create/advanced-settings) — Provedores de login, colaboradores e mais
