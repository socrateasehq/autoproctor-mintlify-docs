...
- [Como Fazer Logout](/candidate/how-to-logout) -- Troque de conta se a conta errada foi usada
- [Métodos de Login do Candidato](/candidate/candidate-login-methods) -- Entenda as opções de login
