...
- [Evidência de Violações Ausente](/issues/missing-violation-evidence) -- Por que algumas violações não possuem fotos de evidência
- [Falso 'Mudou para Outro Aplicativo'](/issues/false-app-switch-alert) -- Outro cenário comum de falso positivo
