...
<Steps>
  ...
  <Step title="Verifique se sua conta tem créditos suficientes">
    ...
    Consulte [Pagamentos e Créditos](/payments-and-credits) para verificar seu saldo e comprar mais se necessário.
  ...
  <Step title="Configure o tempo do teste com margem de tolerância">
    ...
    Consulte [Configurações de Tempo](/timer-settings) para detalhes de configuração.
  </Step>
...
<Steps>
  <Step title="Revise os resultados de supervisão">
    Verifique os [Trust Scores](/what-is-trust-score) e os relatórios de supervisão de cada candidato. Concentre sua revisão nos candidatos com pontuação inferior a 85%.
  ...
  <Step title="Ajude os candidatos com problemas técnicos">
    Se os candidatos enfrentarem algum problema técnico durante o teste, peça que sigam [este artigo](/contact-us).
  </Step>
</Steps>

## Recursos Relacionados

- [Coisas que Você Precisa Saber](/before-you-get-started) — Requisitos essenciais para usar o AutoProctor
...
- [Trust Score](/what-is-trust-score) — Como os Trust Scores são calculados
- [Configurações de Supervisão](/proctoring-settings) — Configure o que é monitorado durante os testes
- [Concorrência](/max-simultaneous-candidates) — Entenda os limites de candidatos simultâneos
