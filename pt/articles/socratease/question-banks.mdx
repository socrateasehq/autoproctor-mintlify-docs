...
<Note>
Os Bancos de Perguntas são um recurso do plano **Elite**. Você precisa de uma assinatura Elite para criar e usar Bancos de Perguntas e Questionários de Bancos de Perguntas. Consulte [Recursos Elite](/elite-plan-features) para detalhes.
</Note>
...
- [Importação em Massa a partir de Excel](/import-questions-from-excel) — Importe perguntas em massa para popular seus Bancos de Perguntas
- [Tipos de Perguntas](/socratease-question-types) — Formatos de perguntas disponíveis para uso nos Bancos de Perguntas
- [Uso de Etiquetas](/using-tags) — Organize perguntas com etiquetas para filtragem e agrupamento
