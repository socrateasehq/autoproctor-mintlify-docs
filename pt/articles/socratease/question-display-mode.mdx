...
<Note>
O Modo de Exibição de Perguntas é um recurso **Premium**. Consulte [Pagamentos e Créditos](/payments-and-credits) para os detalhes do plano.
</Note>
...
Para mais informações sobre configuração de temporizadores, consulte [Configurações de Tempo](/timer-settings).
...
- [Configurações de Tempo](/timer-settings) — Configure temporizadores no nível do teste e da pergunta
- [Como Criar um Questionário Socratease](/create-socratease-quiz) — Guia de criação passo a passo
- [Mostrar Resultados aos Candidatos](/show-results-to-candidates) — Controle a visibilidade dos resultados
