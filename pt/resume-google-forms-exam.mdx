...
- [Retomar Tentativas de Teste](/resume-exam-attempts) — Comportamento geral de retomada em todos os tipos de teste
- [Tentativas Máximas](/maximum-exam-attempts) — Configure quantas tentativas os candidatos podem realizar
- [Testes Não Enviados](/view-unsubmitted-exams) — Veja testes iniciados mas não enviados
