...
<Note>
Para exportações automáticas e contínuas sem downloads manuais, considere configurar a [integração com Google Sheets](/results/write-results-to-google-sheets).
</Note>

## Recursos Relacionados

- [Integração com Google Sheets](/results/write-results-to-google-sheets) -- Escreva resultados automaticamente em uma planilha Google
...
- [Onde Posso Ver os Resultados de Supervisão?](/results/where-to-find-proctoring-results) -- Veja relatórios detalhados de supervisão
