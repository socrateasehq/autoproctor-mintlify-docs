...
<Note>
Se você precisa de dados detalhados por pergunta para Questionários Socratease, use a visualização de [submissões individuais](/results/access-candidate-responses) no [painel do AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>

## Recursos Relacionados

- [Exportar para Excel](/results/export-results-to-excel) -- Baixe resultados manualmente como planilha
- [Acessar Respostas e Entregas do Candidato](/results/access-candidate-responses) -- Veja respostas detalhadas por candidato
...
- [Compartilhar Resultados do Teste](/results/share-exam-results) -- Conceda acesso aos resultados do teste para outros usuários
