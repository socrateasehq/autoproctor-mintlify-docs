...
<Note>
Se você precisa de dados detalhados por pergunta para Questionários Socratease, use a visualização de [submissões individuais](/results/individual-submissions) no [painel do AutoProctor](https://www.autoproctor.co/test-admin/home/).
</Note>
