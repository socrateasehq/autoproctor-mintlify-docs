...
Consulte [Restringir o Acesso ao Teste por Endereço de E-mail](/access/restrict-access-by-email) para instruções completas de configuração e exemplos.
...
Consulte [Convidar Candidatos por E-mail](/access/invite-candidates-via-email) para o processo completo de configuração.
...
- [Restringir o Acesso ao Teste por Endereço de E-mail](/access/restrict-access-by-email) — Configure restrições baseadas em domínio e e-mail
- [Convidar Candidatos por E-mail](/access/invite-candidates-via-email) — Gere links de teste únicos por candidato
- [Métodos de Login do Candidato](/candidate/candidate-login-methods) — Conheça as opções de autenticação disponíveis
- [Configurações Avançadas](/create/advanced-exam-settings) — Configure Restrições de Login e outras opções avançadas
- [Boas Práticas para Criadores de Testes](/understanding/best-practices-for-exam-creators) — Dicas para uma administração de testes tranquila
