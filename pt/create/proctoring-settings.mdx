...
- [Supervisão Avançada](/create/enhanced-proctoring) — Guia detalhado sobre verificação de identidade, detecção de impostor e supervisão em 360°
...
- [O Que é Monitorado](/understanding/what-gets-tracked-during-proctoring) — Lista completa de tudo o que o AutoProctor monitora
- [Resultados de Supervisão](/results/where-to-find-proctoring-results) — Como revisar os dados de supervisão após um teste
- [Trust Score](/understanding/what-is-trust-score) — Como o Trust Score é calculado a partir dos dados de supervisão
