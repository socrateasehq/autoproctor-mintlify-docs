...
- [Retomar Tentativas de Teste](/create/resume-exam-attempts) — Comportamento geral de retomada em todos os tipos de teste
- [Tentativas Máximas](/access/maximum-exam-attempts) — Configure quantas tentativas os candidatos podem realizar
- [Testes Não Enviados](/results/view-unsubmitted-exams) — Veja testes iniciados mas não enviados
