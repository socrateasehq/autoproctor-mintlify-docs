...
<Note>
Se você faz parte de um [Time](/pricing-account/billing-teams/teams), a pessoa que fez a compra inicial recebe os e-mails de fatura. Todos os Administradores do Time também podem baixar faturas na seção de Cobrança.
</Note>
...
Você pode saber mais sobre a seção de Cobrança no artigo [Editar Informações de Cobrança](/pricing-account/billing-teams/billing-information).
...
- [Editar Informações de Cobrança](/pricing-account/billing-teams/billing-information) -- Atualize o nome da empresa, endereço e método de pagamento
...
- [O Que É um Time?](/pricing-account/billing-teams/teams) -- Conheça a cobrança do time e o acesso de administradores
- [Como Cancelar Sua Assinatura](/pricing-account/plans-credits/cancel-subscription) -- Baixe faturas antes do cancelamento
- [Fale Conosco](/pricing-account/support/contact-us) -- Obtenha ajuda com problemas de faturamento
