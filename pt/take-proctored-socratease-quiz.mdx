...
<Steps>
  ...
  <Step title="Solucione problemas se necessário">
    Se a demonstração não carregar, seu dispositivo pode não atender aos requisitos mínimos. Consulte [Compatibilidade de Dispositivos](/device-compatibility) para a lista completa de configurações compatíveis.
  </Step>
</Steps>
...
- [Instruções para Socratease Cronometrado](/take-timed-socratease-quiz) — Instruções para questionários Socratease sem supervisão
