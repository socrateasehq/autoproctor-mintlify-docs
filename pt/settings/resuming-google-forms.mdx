...
<Steps>
  <Step title="Mantenha o salvamento automático ativado no Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl h-96" src="/images/settings/gforms-autosave-enabled.png" alt="Configurações do teste do Google Forms mostrando Disable Autosave desligado, mantendo o salvamento automático ativo" />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Desative o salvamento automático no Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl h-96" src="/images/settings/gforms-autosave-disabled.png" alt="Configurações do teste do Google Forms mostrando Disable Autosave ligado, desativando o salvamento automático" />
    </Frame>
  </Step>
