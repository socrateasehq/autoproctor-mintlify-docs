...
Consulte [Restringir o Acesso ao Teste por Endereço de E-mail](/restrict-access-by-email) para instruções completas de configuração e exemplos.
...
<Note>
Os links de convite únicos estão disponíveis apenas no **Plano Elite** e funcionam com Socratease Quizzes e Testes IFrame. Consulte [Pagamentos e Créditos](/payments-and-credits) para detalhes do plano.
</Note>

Consulte [Convidar Candidatos por E-mail](/invite-candidates-via-email) para o processo completo de configuração.
...
- [Restringir o Acesso ao Teste por Endereço de E-mail](/restrict-access-by-email) — Configure restrições baseadas em domínio e e-mail
- [Convidar Candidatos por E-mail](/invite-candidates-via-email) — Gere links de teste únicos por candidato
- [Métodos de Login do Candidato](/candidate-login-methods) — Conheça as opções de autenticação disponíveis
- [Configurações Avançadas](/advanced-exam-settings) — Configure Restrições de Login e outras opções avançadas
- [Boas Práticas para Criadores de Testes](/best-practices-for-exam-creators) — Dicas para uma administração de testes tranquila
