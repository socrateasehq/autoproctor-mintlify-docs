...
<Frame caption="Formulário do teste carregado em modo somente leitura devido à conta Google incorreta">
  <img src="/images/candidate-issues/cannot-click-form.png" alt="Google Form no AutoProctor que não pode ser clicado porque a conta Google incorreta está ativa" />
</Frame>
