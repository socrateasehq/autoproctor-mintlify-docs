...
- [Não Consigo Ver a Resposta no Google Forms](/issues/google-forms-response-not-visible) -- Respostas ausentes após o envio
- [Não Consigo Clicar na Resposta](/candidate-issues/cannot-click-answers-during-test) -- O formulário carrega mas não é interativo
- [Página em Branco ou Tela Cinza](/candidate-issues/blank-screen-during-test) -- O formulário não carrega de forma alguma
- [Instruções para Testes Supervisionados](/candidate/take-proctored-exam) -- Guia de configuração com seção de Conta Google
