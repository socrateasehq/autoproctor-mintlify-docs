...
Para mais detalhes, consulte [Modo de Exibição de Perguntas](/question-display-mode).
...
Para mais detalhes, consulte [Mostrar Resultados aos Candidatos](/show-results-to-candidates).
...
<Note>
Esta opção está disponível apenas quando você usa o modo [Todas de uma vez (estilo Google Forms)](/question-display-mode).
</Note>
...
Para mais detalhes, consulte [Uso de LaTeX para Equações Matemáticas](/latex-math-equations).
...
- [Modo de Exibição de Perguntas](/question-display-mode) — Explicação detalhada das opções de exibição
- [Mostrar Resultados aos Candidatos](/show-results-to-candidates) — Controle a visibilidade dos resultados
- [Uso de LaTeX para Equações Matemáticas](/latex-math-equations) — Adicione equações matemáticas aos seus questionários
- [Configurações de Tempo](/timer-settings) — Para configuração geral do temporizador e supervisão do teste (separada das configurações do questionário Socratease)
- [Criar um Questionário](/create-socratease-quiz) — Guia passo a passo para criar um questionário
