...
<Frame caption="Cartões de evidência de infrações mostrando incidentes detectados durante um teste supervisionado.">
  <img
    style={{borderRadius: "10px"}}
    src="/images/getting-started/evidence-cards.png"
    alt="Cartões de evidência mostrando trocas de aba, detecção facial, múltiplos rostos, detecção de ruído e contagem de múltiplos monitores"
  />
</Frame>
