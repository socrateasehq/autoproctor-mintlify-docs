...
<Frame caption="Cartões de visão geral de infrações.">
  <img
    className="rounded-xl"
    src="/images/getting-started/evidence-cards.png"
    alt="Cartões de visão geral de infrações mostrando trocas de aba, detecção facial, múltiplos rostos, detecção de ruído e contagem de múltiplos monitores"
  />
</Frame>
