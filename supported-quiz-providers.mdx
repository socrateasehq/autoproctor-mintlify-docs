...
<Steps>
  ...
  <Step title="Configure Proctoring">
    Set up [timer](/timer-settings) and [proctoring](/proctoring-settings) settings. If you chose Socratease, you also configure your questions and grading within AutoProctor. For external providers, your quiz content stays on that platform.
  </Step>
</Steps>
...
<Note>
When using IFrame/Other providers, you can customize the embedded URL using [query arguments](/iframe-query-arguments).
</Note>

## Related Resources

- [Why Socratease?](/why-socratease) -- Benefits of using AutoProctor's native quiz tool
...
- [IFrame Query Arguments](/iframe-query-arguments) -- Customize embedded quiz URLs
- [Advanced Settings](/advanced-exam-settings) -- Login providers, collaborators, and more
