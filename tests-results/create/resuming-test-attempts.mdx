...
<Note>
For Google Forms, you must also keep the **Save Draft** (autosave) setting enabled in Google Forms itself for resume to work properly. See [Resuming Google Forms Tests](/tests-results/create/resuming-google-forms) for detailed configuration.
</Note>
...
If you have [timer settings](/tests-results/create/timer-settings) configured, they affect how resumption works.
...
- [Resuming Google Forms Tests](/tests-results/create/resuming-google-forms) -- Detailed Google Forms resume configuration
- [Maximum Attempts](/tests-results/access-limits/maximum-attempts) -- How attempt limits interact with resumption
- [Unsubmitted Tests](/tests-results/results/unsubmitted-tests) -- View details of tests started but not submitted
- [Timer Settings](/tests-results/create/timer-settings) -- Configure test duration, deadlines, and time windows
