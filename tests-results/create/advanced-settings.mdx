...
For more details on how each login method works, see [Candidate Login Methods](/candidate-guide/attempting/candidate-login-methods).
...
For detailed instructions, see [Restricting by Email](/tests-results/access-limits/restricting-by-email). If you want to invite a specific set of candidates, see [Inviting Candidates via Email](/tests-results/access-limits/inviting-candidates-via-email).
...
For more details, see [Adding Collaborators](/tests-results/access-limits/adding-collaborators).
...
For setup instructions, see [Google Sheets Integration](/tests-results/results/google-sheets-integration).
...
<Note>
Unique URL per candidate is an Elite feature. See [Elite Features](/pricing-account/plans-credits/elite-features) for more details.
</Note>
...
<Note>
Additional Instructions is an Elite feature. See the [Instructions Page for Candidates](/tests-results/create/instructions-page-for-candidates) for more on what candidates see before starting.
</Note>
...
- [Restricting by Email](/tests-results/access-limits/restricting-by-email) — Restrict test access by email address or domain
- [Inviting Candidates via Email](/tests-results/access-limits/inviting-candidates-via-email) — Send test invitations directly
- [Candidate Login Methods](/candidate-guide/attempting/candidate-login-methods) — How each login method works
- [Google Sheets Integration](/tests-results/results/google-sheets-integration) — Auto-export results to spreadsheets
