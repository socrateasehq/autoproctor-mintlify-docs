...
<Steps>
  <Step title="Keep autosave enabled in Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl" style={{maxWidth: "49cqi"}} src="/images/settings/gforms-autosave-enabled.png" alt="Google Forms test settings showing Disable Autosave toggled OFF, keeping autosave active" />
    </Frame>
  </Step>
  <Step title="Enable auto-resume in AutoProctor">
    ...
    <Frame>
      <img style={{maxWidth: "49cqi"}} src="/images/settings/gforms-autoresume-enabled.png" alt="AutoProctor test settings showing Enable Auto-resume toggled ON" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Disable autosave in Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl" style={{maxWidth: "49cqi"}} src="/images/settings/gforms-autosave-disabled.png" alt="Google Forms test settings showing Disable Autosave toggled ON, disabling autosave" />
    </Frame>
  </Step>
  <Step title="Disable auto-resume in AutoProctor">
    ...
    <Frame>
      <img style={{maxWidth: "49cqi"}} src="/images/settings/gforms-autoresume-disabled.png" alt="AutoProctor test settings showing Enable Auto-resume toggled OFF" />
    </Frame>
  </Step>
</Steps>
...
- [Resuming Test Attempts](/tests-results/create/resuming-test-attempts) -- General resume behavior across all test types
- [Maximum Attempts](/tests-results/access-limits/maximum-attempts) -- Configure how many attempts candidates are allowed
- [Unsubmitted Tests](/tests-results/results/unsubmitted-tests) -- View tests started but not submitted
