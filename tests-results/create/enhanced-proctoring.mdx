...
- [Proctoring Settings](/tests-results/create/proctoring-settings) — Basic proctoring options (camera, microphone, tab switching)
- [Trust Score](/understanding/how-proctoring-works/trust-score) — How enhanced proctoring data affects the trust score
- [Proctoring Results](/tests-results/results/proctoring-results) — Reviewing enhanced proctoring results
- [Access Answers and Candidate Responses](/tests-results/results/individual-submissions) — Viewing detailed data for each candidate
- [Payments and Credits](/pricing-account/plans-credits/payments-and-credits) — Understanding credit usage and purchasing
- [Elite Features](/pricing-account/plans-credits/elite-features) — Overview of premium and elite features
