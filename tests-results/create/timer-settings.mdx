...
- [Proctoring Settings](/tests-results/create/proctoring-settings) — Configure camera, microphone, and tab-switching detection
- [Advanced Settings](/tests-results/create/advanced-settings) — Login providers, restrictions, and integrations
- [Quiz Settings](/socratease/settings/quiz-settings) — For Socratease quiz-specific settings, see the Socratease Quiz Settings page
- [Resuming Test Attempts](/tests-results/create/resuming-test-attempts) — How auto-resume works with timed tests
- [What Gets Tracked](/understanding/how-proctoring-works/what-gets-tracked) — Overview of all proctoring capabilities
