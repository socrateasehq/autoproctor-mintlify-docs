...
<Note>
This is a **Premium Feature** and requires a Premium or Elite subscription. See [Payments and Credits](/pricing-account/plans-credits/payments-and-credits) for plan details.
</Note>

## Setup Instructions

<Frame caption="Setting up Google Sheets integration">
  <img className="border rounded-xl" src="/images/settings/write-to-gsheet.gif" alt="GIF showing how to set up Google Sheets integration in AutoProctor" />
</Frame>
...
<Note>
If you need detailed question-level data for Socratease Quizzes, use the [individual submissions](/tests-results/results/individual-submissions) view on the [AutoProctor dashboard](https://www.autoproctor.co/test-admin/home/) instead.
</Note>

## Related Resources

- [Export to Excel](/tests-results/results/export-to-excel) -- Manually download results as a spreadsheet
- [Access Answers and Candidate Responses](/tests-results/results/individual-submissions) -- View detailed per-candidate responses
- [Where Can I See My Quiz Results?](/tests-results/results/how-to-see-results) -- Overview of quiz results vs. proctoring results
- [Payments and Credits](/pricing-account/plans-credits/payments-and-credits) -- Plan details and feature availability
- [Sharing Test Results](/tests-results/results/sharing-test-results) -- Grant other users access to test results
