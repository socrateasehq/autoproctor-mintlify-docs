...
- [Cannot See Response in Google Form](/tests-results/issues/google-forms-response-not-visible) -- Missing responses after submission
- [Cannot Click on Answer](/tests-results/issues/cannot-click-answer) -- Form loads but is not interactive
- [Blank Page or Grey Screen](/tests-results/issues/blank-page-grey-screen) -- Form does not load at all
