...
<Frame caption="AutoProctor loading screen indicating a compatibility issue">
  <img className="border rounded-xl" src="/images/candidate-issues/loading-screen-demo.png" alt="AutoProctor loading screen stuck due to device or browser compatibility issue" />
</Frame>
...
- [Test is Slow and Laggy](/tests-results/issues/slow-and-laggy) -- Troubleshoot performance issues
- [Blank Page or Grey Screen](/tests-results/issues/blank-page-grey-screen) -- Fix blank screen issues
