...
<Frame caption="The two submit buttons: purple for Google Forms, green for AutoProctor">
  <img className="max-h-[300px] border rounded-xl" src="/images/taking-tests/submit-buttons-proctored.png" alt="Purple Google Forms submit button and Green AutoProctor submit button shown on a proctored test" />
</Frame>
...
<Note>
To avoid confusion with two submit buttons, consider using [Socratease quizzes](/socratease/create-questions/why-socratease) instead of Google Forms. Socratease has a single submit button that handles both quiz answers and proctoring in one step.
</Note>

## Related Resources

- [Submit Button Differences](/candidate-guide/attempting/submit-button) -- Full comparison of Socratease vs other quiz types
