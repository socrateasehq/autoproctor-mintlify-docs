...
- [What Gets Tracked](/understanding/how-proctoring-works/what-gets-tracked) -- All events AutoProctor monitors
- [Proctoring Results](/tests-results/results/proctoring-results) -- How to review proctoring reports
- [Test is Slow and Laggy](/tests-results/issues/slow-and-laggy) -- Performance issues that may relate to connectivity
