...
- [Missing Violation Evidence](/tests-results/issues/missing-violation-evidence) -- Why some violations lack evidence photos
- [False 'Switched to Different Application'](/tests-results/issues/false-app-switch) -- Another common false positive scenario
