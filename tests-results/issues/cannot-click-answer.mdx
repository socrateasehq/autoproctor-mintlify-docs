...
<Frame caption="Test form loaded in read-only mode due to incorrect Google account">
  <img className="max-h-[300px] border rounded-xl" src="/images/candidate-issues/cannot-click-form.png" alt="Google Form in AutoProctor that cannot be clicked because the wrong Google account is active" />
</Frame>
...
- [Blank Page or Grey Screen](/tests-results/issues/blank-page-grey-screen) -- Similar issue caused by wrong Google account
- [Cannot See Questions on Google Forms](/tests-results/issues/google-forms-questions-not-visible) -- Google Form access restrictions
- [How to Logout](/candidate-guide/attempting/how-to-logout) -- Steps to switch accounts
- [Instructions for Taking a Proctored Test](/candidate-guide/attempting/proctored-test-instructions) -- Setup guide with Google Account section
