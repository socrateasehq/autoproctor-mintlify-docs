...
<Frame caption="Example of an incorrect candidate name displayed in AutoProctor results">
  <img className="border rounded-xl" src="/images/candidate-issues/incorrect-student-name.png" alt="Incorrect candidate name shown in AutoProctor results page" />
</Frame>
...
- [How to Logout](/candidate-guide/attempting/how-to-logout) -- Switch accounts if the wrong one was used
- [Candidate Login Methods](/candidate-guide/attempting/candidate-login-methods) -- Understand sign-in options
