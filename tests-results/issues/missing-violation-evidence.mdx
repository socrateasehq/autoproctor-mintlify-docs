...
The test administrator may have disabled evidence storage through the test's proctoring configuration. Check your [proctoring settings](/tests-results/create/proctoring-settings) to confirm that evidence recording is enabled.

{/* TODO: Add screenshot of proctoring settings showing evidence recording toggle */}

## Related Resources

- [Proctoring Results](/tests-results/results/proctoring-results) -- How to review proctoring reports
- [Understanding Trust Score](/understanding/how-proctoring-works/trust-score) -- How Trust Scores are calculated
- [Missing Random Photos](/tests-results/issues/missing-random-photos) -- Why random photos may be absent
- [Missing Images and Recordings](/tests-results/issues/missing-images-and-recordings) -- Evidence missing from reports
- [Proctoring Settings](/tests-results/create/proctoring-settings) -- Configure evidence storage and proctoring options
