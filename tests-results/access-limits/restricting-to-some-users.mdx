...
See [Restrict Test Access by Email Address](/tests-results/access-limits/restricting-by-email) for full setup instructions and examples.
...
<Note>
Unique invitation links are available only on the **Elite Plan** and work with Socratease Quizzes and IFrame Tests. See [Payments and Credits](/pricing-account/plans-credits/payments-and-credits) for plan details.
</Note>

See [Inviting Candidates via Email](/tests-results/access-limits/inviting-candidates-via-email) for the complete setup process.
...
- [Restrict Test Access by Email Address](/tests-results/access-limits/restricting-by-email) -- Set up domain and email-based restrictions
...
- [Candidate Login Methods](/candidate-guide/attempting/candidate-login-methods) -- Understand available authentication options
- [Advanced Settings](/tests-results/create/advanced-settings) -- Configure Login Restrictions and other advanced options
