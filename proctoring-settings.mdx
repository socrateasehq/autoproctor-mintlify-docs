...
<Note>
**Customize Message** is a Premium feature. See [Feature Comparison](/feature-comparison) for plan details.
</Note>

## Enhanced Proctoring

<Tip>
Enhanced proctoring adds ID verification, impersonation detection, 360° auxiliary camera, session recording, and candidate video recording. See [Enhanced Proctoring](/enhanced-proctoring) for the full setup guide and credit costs.
</Tip>
...
- [Enhanced Proctoring](/enhanced-proctoring) — Detailed guide on ID verification, impersonation detection, and 360° proctoring
- [What Gets Tracked](/what-gets-tracked-during-proctoring) — Complete list of everything AutoProctor monitors
- [Proctoring Results](/where-to-find-proctoring-results) — How to review proctoring data after a test
- [Trust Score](/what-is-trust-score) — How the trust score is calculated from proctoring data
