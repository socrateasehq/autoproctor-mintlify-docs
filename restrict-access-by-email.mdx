...
<Note>
Email restrictions work in conjunction with the candidate's [login method](/candidate-login-methods). The candidate must sign in with an email address that matches one of the allowed domains or addresses you specified.
</Note>

## Related Resources

- [Candidate Login Methods](/candidate-login-methods) -- Understand available authentication options for candidates
- [Restricting to Specific Users](/restrict-access-to-candidates) -- Other methods for limiting test access
- [Inviting Candidates via Email](/invite-candidates-via-email) -- Generate unique per-candidate test links
- [Advanced Settings](/advanced-exam-settings) -- Configure Login Restrictions and other advanced test options
