...
<Note>
Which feeds AutoProctor accesses depends entirely on how you configure each test. You enable or disable each feed in your [proctoring settings](/proctoring-settings).
</Note>
...
<Note>
All tracking features are configurable per test. Enable only what you need in your [proctoring settings](/proctoring-settings).
</Note>
...
<Warning>
Enabling more tracking features increases the processing load on the candidate's device. If your candidates use older hardware, consider enabling only the features you need most. See [Device Compatibility](/device-compatibility) for minimum requirements.
</Warning>

## Related Resources

- [Trust Score](/what-is-trust-score) -- How AutoProctor scores candidate integrity
- [Proctoring Settings](/proctoring-settings) -- Configure which proctoring features to enable
- [Enhanced Proctoring](/enhanced-proctoring) -- Advanced monitoring options for higher security
- [Proctoring Results](/where-to-find-proctoring-results) -- View violation evidence and reports
- [Video Recording](/does-autoproctor-record-video) -- Why AutoProctor does not record full video
