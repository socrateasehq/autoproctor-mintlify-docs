...
See [Restrict Test Access by Email Address](/access/restrict-access-by-email) for full setup instructions and examples.
...
See [Inviting Candidates via Email](/access/invite-candidates-via-email) for the complete setup process.
...
- [Restrict Test Access by Email Address](/access/restrict-access-by-email) -- Set up domain and email-based restrictions
- [Inviting Candidates via Email](/access/invite-candidates-via-email) -- Generate unique per-candidate test links
- [Candidate Login Methods](/candidate/candidate-login-methods) -- Understand available authentication options
- [Advanced Settings](/create/advanced-exam-settings) -- Configure Login Restrictions and other advanced options
