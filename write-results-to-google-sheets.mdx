...
<Note>
This is a **Premium Feature** and requires a Premium or Elite subscription. See [Payments and Credits](/payments-and-credits) for plan details.
</Note>
...
<Note>
If you need detailed question-level data for Socratease Quizzes, use the [individual submissions](/access-candidate-responses) view on the [AutoProctor dashboard](https://www.autoproctor.co/test-admin/home/) instead.
</Note>

## Related Resources

- [Export to Excel](/export-results-to-excel) -- Manually download results as a spreadsheet
- [Access Answers and Candidate Responses](/access-candidate-responses) -- View detailed per-candidate responses
- [Where Can I See My Quiz Results?](/where-to-find-quiz-results) -- Overview of quiz results vs. proctoring results
- [Payments and Credits](/payments-and-credits) -- Plan details and feature availability
- [Sharing Test Results](/share-exam-results) -- Grant other users access to test results
