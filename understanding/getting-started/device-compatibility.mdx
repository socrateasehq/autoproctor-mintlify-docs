...
<Steps>
  ...
  <Step title="Grant camera, microphone, and screen share permissions">
    ...
    <div style={{display: "flex", flexDirection: "column", gap: "16px", alignItems: "center"}}>
      ...
      <Frame caption="Screen share permission prompt">
        <img
          className="rounded-xl" style={{maxHeight: "300px"}}
          src="/images/getting-started/screen-share-permission.png"
          alt="Browser prompt to share entire screen with autoproctor.co"
        />
      </Frame>
    </div>
  </Step>
...
- [Slow and Laggy Test](/tests-results/issues/slow-and-laggy) -- Fix performance problems
- [Blank Page or Grey Screen](/tests-results/issues/blank-page-grey-screen) -- Resolve display issues
- [Proctored Test Instructions](/candidate-guide/attempting/proctored-test-instructions) -- What candidates need to know before starting
- [Best Practices for Test Creators](/understanding/getting-started/best-practices-for-teachers) -- Tips including sharing the demo test in advance
