...
AutoProctor monitors candidates in real time across multiple channels (depending on your [proctoring settings](/create/proctoring-settings)):
...
- [Proctoring Results](/results/where-to-find-proctoring-results) -- How to view violation evidence and reports
- [Access Answers and Candidate Responses](/results/access-candidate-responses) -- Reviewing a single candidate's report in detail
- [No Face or Multiple Faces Detected](/issues/no-face-or-multiple-faces-detected) -- Why face detection may flag false positives
- [False App Switch Violation](/issues/false-app-switch-alert) -- Understanding false violation flags
- [Best Practices for Test Creators](/understanding/best-practices-for-exam-creators) -- Tips for running effective proctored tests
