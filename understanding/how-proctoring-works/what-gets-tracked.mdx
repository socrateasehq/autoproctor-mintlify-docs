...
<Note>
Which feeds AutoProctor accesses depends entirely on how you configure each test. You enable or disable each feed in your [proctoring settings](/tests-results/create/proctoring-settings).
</Note>
...
<Note>
All tracking features are configurable per test. Enable only what you need in your [proctoring settings](/tests-results/create/proctoring-settings).
</Note>
...
<Warning>
Enabling more tracking features increases the processing load on the candidate's device. If your candidates use older hardware, consider enabling only the features you need most. See [Device Compatibility](/understanding/getting-started/device-compatibility) for minimum requirements.
</Warning>

## Related Resources

- [Trust Score](/understanding/how-proctoring-works/trust-score) -- How AutoProctor scores candidate integrity
- [Proctoring Settings](/tests-results/create/proctoring-settings) -- Configure which proctoring features to enable
- [Enhanced Proctoring](/tests-results/create/enhanced-proctoring) -- Advanced monitoring options for higher security
- [Proctoring Results](/tests-results/results/proctoring-results) -- View violation evidence and reports
- [Video Recording](/understanding/how-proctoring-works/video-recording) -- Why AutoProctor does not record full video
