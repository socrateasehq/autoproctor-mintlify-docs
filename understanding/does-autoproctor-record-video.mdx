...
All of this evidence appears in the candidate's [proctoring report](/results/where-to-find-proctoring-results), organized by timestamp and violation type.

<Warning>
Evidence may occasionally be missing from a report if the candidate's device ran out of storage or if the browser restricted access to the camera or microphone mid-test. See [Missing Images and Recordings](/issues/missing-images-and-recordings) for troubleshooting steps.
</Warning>

## Related Resources

- [What Gets Tracked](/understanding/what-gets-tracked-during-proctoring) -- All monitoring capabilities available during proctoring
- [Trust Score](/understanding/what-is-trust-score) -- How violation evidence is summarized into a score
- [Proctoring Results](/results/where-to-find-proctoring-results) -- How to view violation evidence and reports
- [Missing Images and Recordings](/issues/missing-images-and-recordings) -- Why some evidence may not appear
- [Went Offline Meaning](/issues/what-does-went-offline-mean) -- What happens when a candidate goes offline during a test
