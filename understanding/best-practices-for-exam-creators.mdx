...
<Steps>
  ...
  <Step title="Configure test timing with buffer">
    ...
    See [Timer Settings](/create/timer-settings) for configuration details.
  </Step>
...
<Steps>
  <Step title="Review proctoring results">
    Check [Trust Scores](/understanding/what-is-trust-score) and proctoring reports for each candidate. Focus your review on candidates scoring below 85%.
  ...
  <Step title="Help candidates with technical issues">
    If candidates face any technical issue during the test, ask them to follow [this article](/pricing/contact-us).
  </Step>
</Steps>

## Related Resources

- [Before You Get Started](/understanding/before-you-get-started) -- Critical requirements for using AutoProctor
- [Where Can I See My Quiz Results?](/results/where-to-find-quiz-results) -- Overview of quiz results vs. proctoring results
- [Trust Score](/understanding/what-is-trust-score) -- How Trust Scores are calculated
- [Proctoring Settings](/create/proctoring-settings) -- Configure what gets monitored during tests
- [Concurrency](/access/max-simultaneous-candidates) -- Understand simultaneous candidate limits
