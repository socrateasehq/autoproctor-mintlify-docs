...
<Frame caption="Violation overview cards.">
  <img
    style={{borderRadius: "10px"}}
    src="/images/getting-started/evidence-cards.png"
    alt="Violation overview cards showing tab switches, face detection, multiple faces, noise detection, and multiple monitors counts"
  />
</Frame>
