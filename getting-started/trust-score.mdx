...
- [Access Answers and Candidate Responses](/results/individual-submissions) -- Reviewing a single candidate's report in detail
...
- [Best Practices for Test Creators](/getting-started/best-practices-for-teachers) -- Tips for running effective proctored tests
