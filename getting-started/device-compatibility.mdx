...
<Steps>
  ...
  <Step title="Grant camera and microphone permissions">
    ...
    <div style={{display: "flex", gap: "16px", justifyContent: "center"}}>
      <Frame caption="Microphone permission prompt.">
        <img
          style={{borderRadius: "10px", maxHeight: "250px"}}
          src="/images/getting-started/audio-permission.png"
          alt="Browser permission prompt requesting microphone access for autoproctor.co"
        />
      </Frame>
      <Frame caption="Camera permission prompt.">
        <img
          style={{borderRadius: "10px", maxHeight: "250px"}}
          src="/images/getting-started/video-permission.png"
          alt="Browser permission prompt requesting camera access for autoproctor.co"
        />
      </Frame>
    </div>
  </Step>
