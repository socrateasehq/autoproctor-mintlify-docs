...
<Steps>
  <Step title="Keep autosave enabled in Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl h-96" src="/images/settings/gforms-autosave-enabled.png" alt="Google Forms test settings showing Disable Autosave toggled OFF, keeping autosave active" />
    </Frame>
  </Step>
...
<Steps>
  <Step title="Disable autosave in Google Forms">
    ...
    <Frame>
      <img className="border rounded-xl h-96" src="/images/settings/gforms-autosave-disabled.png" alt="Google Forms test settings showing Disable Autosave toggled ON, disabling autosave" />
    </Frame>
  </Step>
