...
<Frame caption="Results table with Export to Excel button.">
  <img className="border rounded-xl" src="/images/results/export-results-table.png" alt="Results table on the AutoProctor dashboard with export option" />
</Frame>
...
<Frame caption="Exporting results to Excel.">
  <img className="border rounded-xl" src="/images/results/export-results-to-excel.gif" alt="GIF showing how to export results to Excel from the AutoProctor dashboard" />
</Frame>
