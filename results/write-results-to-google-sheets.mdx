...
<Note>
If you need detailed question-level data for Socratease Quizzes, use the [individual submissions](/results/access-candidate-responses) view on the [AutoProctor dashboard](https://www.autoproctor.co/test-admin/home/) instead.
</Note>

## Related Resources

- [Export to Excel](/results/export-results-to-excel) -- Manually download results as a spreadsheet
- [Access Answers and Candidate Responses](/results/access-candidate-responses) -- View detailed per-candidate responses
...
- [Sharing Test Results](/results/share-exam-results) -- Grant other users access to test results
