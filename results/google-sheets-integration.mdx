...
<Note>
If you need detailed question-level data for Socratease Quizzes, use the [individual submissions](/results/individual-submissions) view on the [AutoProctor dashboard](https://www.autoproctor.co/test-admin/home/) instead.
</Note>
