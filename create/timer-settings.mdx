...
- [Proctoring Settings](/create/proctoring-settings) — Configure camera, microphone, and tab-switching detection
- [Advanced Settings](/create/advanced-exam-settings) — Login providers, restrictions, and integrations
- [Quiz Settings](/socratease/socratease-quiz-settings) — For Socratease quiz-specific settings, see the Socratease Quiz Settings page
- [Resuming Test Attempts](/create/resume-exam-attempts) — How auto-resume works with timed tests
- [What Gets Tracked](/understanding/what-gets-tracked-during-proctoring) — Overview of all proctoring capabilities
