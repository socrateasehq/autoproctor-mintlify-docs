...
For more details on how each login method works, see [Candidate Login Methods](/candidate/candidate-login-methods).
...
For detailed instructions, see [Restricting by Email](/access/restrict-access-by-email). If you want to invite a specific set of candidates, see [Inviting Candidates via Email](/access/invite-candidates-via-email).
...
For more details, see [Adding Collaborators](/access/add-collaborators).
...
For setup instructions, see [Google Sheets Integration](/results/write-results-to-google-sheets).
...
<Note>
Unique URL per candidate is an Elite feature. See [Elite Features](/pricing/elite-plan-features) for more details.
</Note>
...
<Note>
Additional Instructions is an Elite feature. See the [Instructions Page for Candidates](/create/candidate-instructions-page) for more on what candidates see before starting.
</Note>
...
- [Restricting by Email](/access/restrict-access-by-email) — Restrict test access by email address or domain
- [Inviting Candidates via Email](/access/invite-candidates-via-email) — Send test invitations directly
- [Candidate Login Methods](/candidate/candidate-login-methods) — How each login method works
- [Google Sheets Integration](/results/write-results-to-google-sheets) — Auto-export results to spreadsheets
